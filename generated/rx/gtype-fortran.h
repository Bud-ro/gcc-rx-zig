	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  }
  {
    ...
    for (i2 = 0; i2 != l2; i2++) {
      if ((void *)(x) == this_obj)
        op (&((*x).stride[i2]), NULL, cookie);
    }
  }
  if ((void *)(x) == this_obj)
    op (&((*x).size), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).offset), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dtype), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dataptr_type), NULL, cookie);
  {
    size_t i3;
    size_t l3 = (size_t)(2);
    for (i3 = 0; i3 != l3; i3++) {
      if ((void *)(x) == this_obj)
        op (&((*x).base_decl[i3]), NULL, cookie);
    }
  }
  if ((void *)(x) == this_obj)
    op (&((*x).nonrestricted_type), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).caf_token), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).caf_offset), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).saved_descriptor), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).stringlen), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).addr), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).token), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).caf_offset), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).namespace_decl), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).decls), NULL, cookie);
}
