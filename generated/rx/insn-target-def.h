...
#define TARGET_HAVE_INSV hook_bool_void_true
...
static rtx_insn *
target_gen_movstr (rtx x0, rtx x1, rtx x2)
{
  gcc_checking_assert (targetm.have_movstr ());
  return insnify (gen_movstr (x0, x1, x2));
}

#undef TARGET_HAVE_MOVSTR
#define TARGET_HAVE_MOVSTR target_have_movstr
#undef TARGET_GEN_MOVSTR
#define TARGET_GEN_MOVSTR target_gen_movstr
#undef TARGET_CODE_FOR_MOVSTR
#define TARGET_CODE_FOR_MOVSTR CODE_FOR_movstr
...
#define TARGET_HAVE_TRAP hook_bool_void_false
#undef TARGET_GEN_TRAP
#define TARGET_GEN_TRAP invalid_void
...
#define TARGET_HAVE_UNTYPED_CALL hook_bool_void_false
#undef TARGET_GEN_UNTYPED_CALL
#define TARGET_GEN_UNTYPED_CALL invalid_rtx_rtx_rtx
