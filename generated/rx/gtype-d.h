            ...
            case TS_SSA_NAME:
              ...
              switch ((int) (((*x).generic.ssa_name).typed.type ?!POINTER_TYPE_P (TREE_TYPE ((tree)&((*x).generic.ssa_name))) : 2))
                ...
                case 0:
                  ...
                  break;
                case 1:
                  gt_ggc_m_14vrange_storage ((*x).generic.ssa_name.info.range_info);
                  break;
                default:
                  break;
                }
  ...
  while (x != xlimit)
    {
      switch ((int) (d_tree_node_structure (&((*x)))))
            ...
            case TS_SSA_NAME:
              ...
              switch ((int) (((*x).generic.ssa_name).typed.type ?!POINTER_TYPE_P (TREE_TYPE ((tree)&((*x).generic.ssa_name))) : 2))
                ...
                case 0:
                  ...
                  break;
                case 1:
                  gt_pch_n_14vrange_storage ((*x).generic.ssa_name.info.range_info);
                  break;
                default:
                  break;
                }
        ...
        case TS_D_IDENTIFIER:
          ...
          gt_pch_n_S2 ((*x).identifier.common.id.str, 1 + ((*x).identifier.common.id).len);
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).frame_field), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).named_result), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).thunks), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).frame_info), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (d_tree_node_structure (&((*x)))))
    ...
    case TS_D_IDENTIFIER:
      ...
      if ((void *)(x) == this_obj)
        op (&((*x).identifier.pretty_ident), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).identifier.decl_tree), NULL, cookie);
      break;
    case TS_D_FRAMEINFO:
      if ((void *)(x) == this_obj)
        op (&((*x).frameinfo.common.typed.type), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).frameinfo.common.chain), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).frameinfo.frame_type), NULL, cookie);
      break;
    default:
      break;
    }
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).static_chain), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).stmt_list), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).vars_in_scope), NULL, cookie);
  if ((void *)(x) == this_obj)
