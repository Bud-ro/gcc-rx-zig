		      ...
		      struct gcc_options *opts_set)
{
  ...
  gcc_assert (IN_RANGE (opts->x_flag_fold_mem_offsets, -128, 127));
  ...
  gcc_assert (IN_RANGE (opts->x_flag_harden_control_flow_redundancy_check_exceptions, -128, 127));
  gcc_assert (IN_RANGE (opts->x_flag_harden_control_flow_redundancy_check_returning_calls, -128, 127));
  gcc_assert (IN_RANGE (opts->x_flag_harden_control_flow_redundancy_skip_leaf, -128, 127));
  ...
  gcc_assert (IN_RANGE (opts->x_flag_harden_control_flow_redundancy, -128, 127));
  ...
  gcc_assert (IN_RANGE (opts->x_flag_unreachable_traps, -128, 127));
  ...
  ptr->x_param_asan_kernel_mem_intrinsic_prefix = opts->x_param_asan_kernel_mem_intrinsic_prefix;
  ...
  ptr->x_param_fully_pipelined_fma = opts->x_param_fully_pipelined_fma;
  ...
  ptr->x_param_hardcfr_max_blocks = opts->x_param_hardcfr_max_blocks;
  ptr->x_param_hardcfr_max_inline_blocks = opts->x_param_hardcfr_max_inline_blocks;
  ...
  ptr->x_param_ipa_sra_deref_prob_threshold = opts->x_param_ipa_sra_deref_prob_threshold;
  ...
  ptr->x_param_ipa_sra_ptrwrap_growth_factor = opts->x_param_ipa_sra_ptrwrap_growth_factor;
  ...
  ptr->x_param_ira_simple_lra_insn_threshold = opts->x_param_ira_simple_lra_insn_threshold;
  ...
  ptr->x_param_max_jump_thread_paths = opts->x_param_max_jump_thread_paths;
  ...
  ptr->x_param_max_unswitch_depth = opts->x_param_max_unswitch_depth;
  ...
  ptr->x_param_ranger_recompute_depth = opts->x_param_ranger_recompute_depth;
  ...
  ptr->x_param_uninit_max_chain_len = opts->x_param_uninit_max_chain_len;
  ptr->x_param_uninit_max_num_chains = opts->x_param_uninit_max_num_chains;
  ...
  ptr->x_param_vect_max_layout_candidates = opts->x_param_vect_max_layout_candidates;
  ...
  ptr->x_param_vrp_sparse_threshold = opts->x_param_vrp_sparse_threshold;
  ptr->x_param_vrp_switch_limit = opts->x_param_vrp_switch_limit;
  ptr->x_param_vrp_vector_threshold = opts->x_param_vrp_vector_threshold;
  ptr->x_flag_min_function_alignment = opts->x_flag_min_function_alignment;
  ptr->x_flag_openmp_target_simd_clone = opts->x_flag_openmp_target_simd_clone;
  ...
  ptr->x_flag_harden_control_flow_redundancy_check_noreturn = opts->x_flag_harden_control_flow_redundancy_check_noreturn;
  ptr->x_flag_inline_stringops = opts->x_flag_inline_stringops;
  ...
  ptr->x_flag_fold_mem_offsets = opts->x_flag_fold_mem_offsets;
  ...
  ptr->x_flag_harden_control_flow_redundancy_check_exceptions = opts->x_flag_harden_control_flow_redundancy_check_exceptions;
  ptr->x_flag_harden_control_flow_redundancy_check_returning_calls = opts->x_flag_harden_control_flow_redundancy_check_returning_calls;
  ptr->x_flag_harden_control_flow_redundancy_skip_leaf = opts->x_flag_harden_control_flow_redundancy_skip_leaf;
  ...
  ptr->x_flag_harden_control_flow_redundancy = opts->x_flag_harden_control_flow_redundancy;
  ...
  ptr->x_flag_unreachable_traps = opts->x_flag_unreachable_traps;
  ...
  if (opts_set->x_param_asan_kernel_mem_intrinsic_prefix) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_param_asan_memintrin) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_param_asan_stack) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_param_asan_use_after_return) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_param_avg_loop_niter) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_param_avoid_fma_max_bits) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_param_builtin_expect_probability) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_param_builtin_string_cmp_inline_length) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_param_case_values_threshold) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_param_comdat_sharing_probability) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_param_construct_interfere_size) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_destruct_interfere_size) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_dse_max_alias_queries_per_store) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_dse_max_object_size) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_early_inlining_insns) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_fsm_scale_path_stmts) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_fully_pipelined_fma) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_gcse_after_reload_critical_fraction) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_gcse_after_reload_partial_fraction) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_gcse_cost_distance_ratio) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_gcse_unrestricted_cost) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_graphite_max_arrays_per_scop) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_param_graphite_max_nb_scop_params) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_hardcfr_max_blocks) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_hardcfr_max_inline_blocks) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_hwasan_instrument_allocas) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_hwasan_instrument_mem_intrinsics) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_param_hwasan_instrument_reads) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_param_hwasan_instrument_stack) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_param_hwasan_instrument_writes) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_hwasan_random_frame_tag) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_param_inline_heuristics_hint_percent) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_param_inline_min_speedup) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_param_inline_unit_growth) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_param_ipa_cp_eval_threshold) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_param_ipa_cp_large_unit_insns) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_param_ipa_cp_loop_hint_bonus) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_param_ipa_cp_max_recursive_depth) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_param_ipa_cp_min_recursive_probability) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_param_ipa_cp_profile_count_base) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_param_ipa_cp_recursion_penalty) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_param_ipa_cp_recursive_freq_factor) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_param_ipa_cp_single_call_penalty) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_param_ipa_cp_unit_growth) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_param_ipa_cp_value_list_size) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_param_ipa_jump_function_lookups) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_param_ipa_max_aa_steps) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_ipa_max_agg_items) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_ipa_max_loop_predicates) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_param_ipa_max_param_expr_ops) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_param_ipa_max_switch_predicate_bounds) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_param_ipa_sra_deref_prob_threshold) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_param_ipa_sra_max_replacements) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_param_ipa_sra_ptr_growth_factor) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_param_ipa_sra_ptrwrap_growth_factor) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_ira_consider_dup_in_all_alts) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_param_ira_loop_reserved_regs) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_param_ira_max_conflict_table_size) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[0] = mask;
  mask = 0;
  if (opts_set->x_param_ira_max_loops_num) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_param_ira_simple_lra_insn_threshold) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_param_iv_always_prune_cand_set_bound) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_param_iv_consider_all_candidates_bound) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_param_iv_max_considered_uses) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_param_jump_table_max_growth_ratio_for_size) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_param_jump_table_max_growth_ratio_for_speed) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_param_l1_cache_line_size) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_param_l1_cache_size) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_param_l2_cache_size) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_param_large_function_growth) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_param_large_function_insns) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_param_stack_frame_growth) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_param_large_stack_frame) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_param_large_unit_insns) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_param_lim_expensive) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_param_loop_block_tile_size) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_loop_interchange_max_num_stmts) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_loop_interchange_stride_ratio) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_loop_invariant_max_bbs_in_loop) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_loop_max_datarefs_for_datadeps) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_loop_versioning_max_inner_insns) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_loop_versioning_max_outer_insns) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_lra_inheritance_ebb_probability_cutoff) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_lra_max_considered_reload_pseudos) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_max_average_unrolled_insns) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_max_combine_insns) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_max_unroll_iterations) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_param_max_completely_peel_times) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_max_completely_peeled_insns) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_max_crossjump_edges) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_max_cse_insns) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_max_cse_path_length) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_param_max_cselib_memory_locations) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_param_max_debug_marker_count) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_param_max_delay_slot_insn_search) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_max_delay_slot_live_search) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_param_max_dse_active_local_stores) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_param_early_inliner_max_iterations) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_param_max_find_base_term_values) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_param_max_fsm_thread_path_insns) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_param_max_gcse_insertion_ratio) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_param_max_gcse_memory) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_param_max_goto_duplication_insns) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_param_max_grow_copy_bb_insns) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_param_max_hoist_depth) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_param_inline_functions_called_once_insns) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_param_inline_functions_called_once_loop_depth) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_param_max_inline_insns_auto) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_param_max_inline_insns_recursive_auto) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_param_max_inline_insns_recursive) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_param_max_inline_insns_single) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_param_max_inline_insns_size) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_max_inline_insns_small) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_max_inline_recursive_depth_auto) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_param_max_inline_recursive_depth) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_param_max_isl_operations) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_param_max_iterations_computation_cost) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_param_max_iterations_to_track) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_param_max_jump_thread_duplication_stmts) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_param_max_jump_thread_paths) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_max_last_value_rtl) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_param_max_loop_header_insns) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_param_max_modulo_backtrack_attempts) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[1] = mask;
  mask = 0;
  if (opts_set->x_param_max_partial_antic_length) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_param_max_peel_branches) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_param_max_peel_times) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_param_max_peeled_insns) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_param_max_pending_list_length) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_param_max_pipeline_region_blocks) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_param_max_pipeline_region_insns) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_param_max_pow_sqrt_depth) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_param_max_predicted_iterations) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_param_max_reload_search_insns) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_param_max_rtl_if_conversion_insns) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_param_max_rtl_if_conversion_predictable_cost) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_param_max_rtl_if_conversion_unpredictable_cost) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_param_max_sched_extend_regions_iters) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_param_max_sched_insn_conflict_delay) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_param_max_sched_ready_insns) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_param_max_sched_region_blocks) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_max_sched_region_insns) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_max_slsr_candidate_scan) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_max_speculative_devirt_maydefs) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_max_stores_to_merge) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_max_stores_to_sink) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_max_tail_merge_comparisons) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_max_tail_merge_iterations) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_max_tracked_strlens) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_max_tree_if_conversion_phi_args) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_max_unroll_times) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_max_unrolled_insns) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_param_max_unswitch_depth) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_max_unswitch_insns) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_max_variable_expansions) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_max_vartrack_expr_depth) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_max_vartrack_reverse_op_size) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_param_max_vartrack_size) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_param_min_crossjump_insns) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_param_min_inline_recursive_probability) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_min_insn_to_prefetch_ratio) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_param_min_loop_cond_split_prob) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_param_min_pagesize) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_param_min_size_for_stack_sharing) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_param_min_spec_prob) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_param_min_vect_loop_bound) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_param_modref_max_accesses) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_param_modref_max_adjustments) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_param_modref_max_bases) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_param_modref_max_depth) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_param_modref_max_escape_points) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_param_modref_max_refs) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_param_modref_max_tests) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_param_parloops_chunk_size) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_param_parloops_min_per_thread) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_param_parloops_schedule) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_param_partial_inlining_entry_probability) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_predictable_branch_outcome) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_prefetch_dynamic_strides) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_param_prefetch_latency) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_param_prefetch_min_insn_to_mem_ratio) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_param_prefetch_minimum_stride) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_param_ranger_logical_depth) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_param_ranger_recompute_depth) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_param_relation_block_limit) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_rpo_vn_max_loop_depth) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_param_sccvn_max_alias_queries_per_access) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_param_scev_max_expr_complexity) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[2] = mask;
  mask = 0;
  if (opts_set->x_param_scev_max_expr_size) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_param_sched_autopref_queue_depth) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_param_sched_mem_true_dep_cost) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_param_sched_pressure_algorithm) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_param_sched_spec_prob_cutoff) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_param_sched_state_edge_prob_cutoff) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_param_selsched_insns_to_rename) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_param_selsched_max_lookahead) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_param_selsched_max_sched_times) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_param_simultaneous_prefetches) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_param_sink_frequency_threshold) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_param_sms_dfa_history) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_param_sms_loop_average_count_threshold) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_param_sms_max_ii_factor) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_param_sms_min_sc) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_param_sra_max_propagations) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_param_sra_max_scalarization_size_size) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_sra_max_scalarization_size_speed) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_ssa_name_def_chain_limit) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_ssp_buffer_size) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_stack_clash_protection_guard_size) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_stack_clash_protection_probe_interval) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_store_merging_allow_unaligned) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_store_merging_max_size) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_switch_conversion_branch_ratio) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_tm_max_aggregate_size) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_tracer_dynamic_coverage_feedback) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_tracer_dynamic_coverage) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_param_tracer_max_code_growth) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_tracer_min_branch_probability_feedback) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_tracer_min_branch_probability) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_tracer_min_branch_ratio) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_tree_reassoc_width) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_param_uninit_control_dep_attempts) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_param_uninit_max_chain_len) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_param_uninit_max_num_chains) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_uninlined_function_insns) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_param_uninlined_function_time) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_param_uninlined_function_thunk_insns) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_param_uninlined_function_thunk_time) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_param_unlikely_bb_count_fraction) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_param_unroll_jam_max_unroll) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_param_unroll_jam_min_percent) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_param_use_after_scope_direct_emission_threshold) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_param_vect_epilogues_nomask) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_param_vect_induction_float) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_param_vect_inner_loop_cost_factor) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_param_vect_max_layout_candidates) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_param_vect_max_peeling_for_alignment) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_param_vect_max_version_for_alias_checks) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_param_vect_max_version_for_alignment_checks) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_param_vect_partial_vector_usage) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_param_vrp_sparse_threshold) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_vrp_switch_limit) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_vrp_vector_threshold) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_min_function_alignment) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_openmp_target_simd_clone) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_sched_stalled_insns) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_sched_stalled_insns_dep) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_tree_parallelize_loops) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_param_ranger_debug) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_threader_debug) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_excess_precision) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_fp_contract_mode) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[3] = mask;
  mask = 0;
  if (opts_set->x_flag_harden_control_flow_redundancy_check_noreturn) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_inline_stringops) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_ira_algorithm) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_ira_region) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_live_patching) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_reorder_blocks_algorithm) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_simd_cost_model) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_stack_reuse) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_auto_var_init) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_vect_cost_model) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_optimize) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_optimize_size) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_optimize_debug) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_optimize_fast) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_warn_inline) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_aggressive_loop_optimizations) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_align_functions) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_align_jumps) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_align_labels) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_align_loops) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_allocation_dce) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_store_data_races) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_associative_math) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_asynchronous_unwind_tables) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_auto_inc_dec) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_bit_tests) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_branch_on_count_reg) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_branch_probabilities) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_caller_saves) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_code_hoisting) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_combine_stack_adjustments) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_compare_elim_after_reload) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_conserve_stack) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_cprop_registers) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_crossjumping) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_cse_follow_jumps) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_cx_fortran_rules) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_cx_limited_range) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_dce) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_defer_pop) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_delayed_branch) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_delete_dead_exceptions) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_delete_null_pointer_checks) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_devirtualize) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_devirtualize_speculatively) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_dse) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_early_inlining) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_exceptions) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_expensive_optimizations) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_finite_loops) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_finite_math_only) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_float_store) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_fold_mem_offsets) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_fold_simple_inlines) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_forward_propagate) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_fp_int_builtin_inexact) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_no_function_cse) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_gcse) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_gcse_after_reload) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_gcse_las) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_gcse_lm) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_gcse_sm) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_graphite) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_graphite_identity) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[4] = mask;
  mask = 0;
  if (opts_set->x_flag_guess_branch_prob) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_harden_control_flow_redundancy_check_exceptions) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_harden_control_flow_redundancy_check_returning_calls) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_harden_control_flow_redundancy_skip_leaf) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_harden_compares) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_harden_conditional_branches) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_harden_control_flow_redundancy) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_hoist_adjacent_loads) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_if_conversion) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_if_conversion2) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_indirect_inlining) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_no_inline) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_inline_atomics) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_inline_functions) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_inline_functions_called_once) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_inline_small_functions) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_ipa_bit_cp) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_ipa_cp) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_ipa_cp_clone) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_ipa_icf) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_ipa_icf_functions) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_ipa_icf_variables) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_ipa_modref) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_ipa_profile) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_ipa_pta) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_ipa_pure_const) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_ipa_ra) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_ipa_reference) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_ipa_reference_addressable) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_ipa_sra) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_ipa_stack_alignment) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_ipa_strict_aliasing) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_ipa_vrp) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_ira_hoist_pressure) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_ira_loop_pressure) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_ira_share_save_slots) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_ira_share_spill_slots) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_isolate_erroneous_paths_attribute) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_isolate_erroneous_paths_dereference) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_ivopts) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_jump_tables) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_keep_gc_roots_live) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_lifetime_dse) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_limit_function_alignment) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_live_range_shrinkage) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_loop_interchange) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_loop_nest_optimize) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_loop_parallelize_all) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_unroll_jam) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_lra_remat) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_errno_math) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_modulo_sched) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_modulo_sched_allow_regmoves) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_move_loop_invariants) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_move_loop_stores) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_non_call_exceptions) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_nothrow_opt) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_omit_frame_pointer) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_opt_info) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_optimize_sibling_calls) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_optimize_strlen) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_pack_struct) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_partial_inlining) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_peel_loops) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[5] = mask;
  mask = 0;
  if (opts_set->x_flag_no_peephole) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_peephole2) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_plt) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_predictive_commoning) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_prefetch_loop_arrays) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_printf_return_value) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_profile_partial_training) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_profile_reorder_functions) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_reciprocal_math) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_ree) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_pcc_struct_return) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_rename_registers) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_reorder_blocks) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_reorder_blocks_and_partition) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_reorder_functions) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_rerun_cse_after_loop) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_resched_modulo_sched) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_rounding_math) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_rtti) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_save_optimization_record) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_sched_critical_path_heuristic) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_sched_dep_count_heuristic) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_sched_group_heuristic) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_schedule_interblock) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_sched_last_insn_heuristic) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_sched_pressure) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_sched_rank_heuristic) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_schedule_speculative) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_sched_spec_insn_heuristic) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_schedule_speculative_load) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_schedule_speculative_load_dangerous) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_sched2_use_superblocks) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_schedule_fusion) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_schedule_insns) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_schedule_insns_after_reload) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_section_anchors) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_sel_sched_pipelining) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_sel_sched_pipelining_outer_loops) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_sel_sched_reschedule_pipelined) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_selective_scheduling) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_selective_scheduling2) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_semantic_interposition) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_short_enums) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_short_wchar) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_shrink_wrap) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_shrink_wrap_separate) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_signaling_nans) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_signed_zeros) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_single_precision_constant) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_split_ivs_in_unroller) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_split_loops) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_split_paths) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_split_wide_types) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_split_wide_types_early) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_ssa_backprop) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_ssa_phiopt) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_stack_clash_protection) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_stack_protect) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_stdarg_opt) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_store_merging) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_strict_aliasing) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_strict_enums) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_strict_volatile_bitfields) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_thread_jumps) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[6] = mask;
  mask = 0;
  if (opts_set->x_flag_threadsafe_statics) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_toplevel_reorder) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_tracer) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_trapping_math) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_trapv) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_tree_bit_ccp) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_tree_builtin_call_dce) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_tree_ccp) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_tree_ch) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_tree_coalesce_vars) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_tree_copy_prop) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_tree_cselim) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_tree_dce) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_tree_dom) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_tree_dse) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_tree_forwprop) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_tree_fre) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_tree_loop_distribute_patterns) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_tree_loop_distribution) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_tree_loop_if_convert) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_tree_loop_im) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_tree_loop_ivcanon) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_tree_loop_optimize) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_tree_loop_vectorize) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_tree_live_range_split) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_tree_partial_pre) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_tree_phiprop) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_tree_pre) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_tree_pta) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_tree_reassoc) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_tree_scev_cprop) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_tree_sink) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_tree_slp_vectorize) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_tree_slsr) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_tree_sra) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_tree_switch_conversion) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_tree_tail_merge) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_tree_ter) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_tree_vectorize) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_tree_vrp) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_unconstrained_commons) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_unreachable_traps) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_unroll_all_loops) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_cunroll_grow_size) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_unroll_loops) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_unsafe_math_optimizations) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_unswitch_loops) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_unwind_tables) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_var_tracking) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_var_tracking_assignments) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_var_tracking_assignments_toggle) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_var_tracking_uninit) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_variable_expansion_in_unroller) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_version_loops_for_strides) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_value_profile_transformations) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_web) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_wrapv) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_wrapv_pointer) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_debug_nonbind_markers_p) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_str_align_functions) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_str_align_jumps) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_str_align_labels) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_str_align_loops) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_patchable_function_entry) mask |= HOST_WIDE_INT_1U << 63;
			 ...
			 struct cl_optimization *ptr)
{
  ...
  opts->x_param_asan_kernel_mem_intrinsic_prefix = ptr->x_param_asan_kernel_mem_intrinsic_prefix;
  ...
  opts->x_param_fully_pipelined_fma = ptr->x_param_fully_pipelined_fma;
  ...
  opts->x_param_hardcfr_max_blocks = ptr->x_param_hardcfr_max_blocks;
  opts->x_param_hardcfr_max_inline_blocks = ptr->x_param_hardcfr_max_inline_blocks;
  ...
  opts->x_param_ipa_sra_deref_prob_threshold = ptr->x_param_ipa_sra_deref_prob_threshold;
  ...
  opts->x_param_ipa_sra_ptrwrap_growth_factor = ptr->x_param_ipa_sra_ptrwrap_growth_factor;
  ...
  opts->x_param_ira_simple_lra_insn_threshold = ptr->x_param_ira_simple_lra_insn_threshold;
  ...
  opts->x_param_max_jump_thread_paths = ptr->x_param_max_jump_thread_paths;
  ...
  opts->x_param_max_unswitch_depth = ptr->x_param_max_unswitch_depth;
  ...
  opts->x_param_ranger_recompute_depth = ptr->x_param_ranger_recompute_depth;
  ...
  opts->x_param_uninit_max_chain_len = ptr->x_param_uninit_max_chain_len;
  opts->x_param_uninit_max_num_chains = ptr->x_param_uninit_max_num_chains;
  ...
  opts->x_param_vect_max_layout_candidates = ptr->x_param_vect_max_layout_candidates;
  ...
  opts->x_param_vrp_sparse_threshold = ptr->x_param_vrp_sparse_threshold;
  opts->x_param_vrp_switch_limit = ptr->x_param_vrp_switch_limit;
  opts->x_param_vrp_vector_threshold = ptr->x_param_vrp_vector_threshold;
  opts->x_flag_min_function_alignment = ptr->x_flag_min_function_alignment;
  opts->x_flag_openmp_target_simd_clone = ptr->x_flag_openmp_target_simd_clone;
  ...
  opts->x_flag_harden_control_flow_redundancy_check_noreturn = ptr->x_flag_harden_control_flow_redundancy_check_noreturn;
  opts->x_flag_inline_stringops = ptr->x_flag_inline_stringops;
  ...
  opts->x_flag_fold_mem_offsets = ptr->x_flag_fold_mem_offsets;
  ...
  opts->x_flag_harden_control_flow_redundancy_check_exceptions = ptr->x_flag_harden_control_flow_redundancy_check_exceptions;
  opts->x_flag_harden_control_flow_redundancy_check_returning_calls = ptr->x_flag_harden_control_flow_redundancy_check_returning_calls;
  opts->x_flag_harden_control_flow_redundancy_skip_leaf = ptr->x_flag_harden_control_flow_redundancy_skip_leaf;
  ...
  opts->x_flag_harden_control_flow_redundancy = ptr->x_flag_harden_control_flow_redundancy;
  ...
  opts->x_flag_unreachable_traps = ptr->x_flag_unreachable_traps;
  ...
  mask >>= 1;
  opts_set->x_param_asan_kernel_mem_intrinsic_prefix = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_fully_pipelined_fma = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_hardcfr_max_blocks = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_hardcfr_max_inline_blocks = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_ipa_sra_deref_prob_threshold = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_ipa_sra_max_replacements = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_ipa_sra_ptr_growth_factor = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_ipa_sra_ptrwrap_growth_factor = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_ira_simple_lra_insn_threshold = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_max_jump_thread_paths = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_max_unswitch_depth = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_ranger_recompute_depth = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_uninit_max_chain_len = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_uninit_max_num_chains = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_vect_max_layout_candidates = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_vrp_sparse_threshold = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_vrp_switch_limit = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_vrp_vector_threshold = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_flag_min_function_alignment = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_flag_openmp_target_simd_clone = (mask & 1) != 0;
  mask >>= 1;
  ...
  opts_set->x_flag_harden_control_flow_redundancy_check_noreturn = static_cast<enum hardcfr_noret >((mask & 1) != 0);
  mask >>= 1;
  opts_set->x_flag_inline_stringops = static_cast<enum ilsop_fn >((mask & 1) != 0);
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_fold_mem_offsets = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_harden_control_flow_redundancy_check_exceptions = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_flag_harden_control_flow_redundancy_check_returning_calls = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_flag_harden_control_flow_redundancy_skip_leaf = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_flag_harden_compares = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_flag_harden_conditional_branches = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_flag_harden_control_flow_redundancy = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_unreachable_traps = (mask & 1) != 0;
  mask >>= 1;
                       ...
                       struct cl_optimization *ptr)
{
  ...
  if (ptr->x_param_asan_kernel_mem_intrinsic_prefix)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_asan_kernel_mem_intrinsic_prefix",
             ptr->x_param_asan_kernel_mem_intrinsic_prefix);
  ...
  if (ptr->x_param_fully_pipelined_fma)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_fully_pipelined_fma",
             ptr->x_param_fully_pipelined_fma);
  ...
  if (ptr->x_param_hardcfr_max_blocks)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_hardcfr_max_blocks",
             ptr->x_param_hardcfr_max_blocks);

  if (ptr->x_param_hardcfr_max_inline_blocks)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_hardcfr_max_inline_blocks",
             ptr->x_param_hardcfr_max_inline_blocks);
  ...
  if (ptr->x_param_ipa_sra_deref_prob_threshold)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_ipa_sra_deref_prob_threshold",
             ptr->x_param_ipa_sra_deref_prob_threshold);
  ...
  if (ptr->x_param_ipa_sra_ptrwrap_growth_factor)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_ipa_sra_ptrwrap_growth_factor",
             ptr->x_param_ipa_sra_ptrwrap_growth_factor);
  ...
  if (ptr->x_param_ira_simple_lra_insn_threshold)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_ira_simple_lra_insn_threshold",
             ptr->x_param_ira_simple_lra_insn_threshold);
  ...
  if (ptr->x_param_max_jump_thread_paths)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_max_jump_thread_paths",
             ptr->x_param_max_jump_thread_paths);
  ...
  if (ptr->x_param_max_unswitch_depth)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_max_unswitch_depth",
             ptr->x_param_max_unswitch_depth);
  ...
  if (ptr->x_param_ranger_recompute_depth)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_ranger_recompute_depth",
             ptr->x_param_ranger_recompute_depth);
  ...
  if (ptr->x_param_uninit_max_chain_len)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_uninit_max_chain_len",
             ptr->x_param_uninit_max_chain_len);

  if (ptr->x_param_uninit_max_num_chains)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_uninit_max_num_chains",
             ptr->x_param_uninit_max_num_chains);
  ...
  if (ptr->x_param_vect_max_layout_candidates)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_vect_max_layout_candidates",
             ptr->x_param_vect_max_layout_candidates);
  ...
  if (ptr->x_param_vrp_sparse_threshold)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_vrp_sparse_threshold",
             ptr->x_param_vrp_sparse_threshold);

  if (ptr->x_param_vrp_switch_limit)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_vrp_switch_limit",
             ptr->x_param_vrp_switch_limit);

  if (ptr->x_param_vrp_vector_threshold)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_vrp_vector_threshold",
             ptr->x_param_vrp_vector_threshold);

  if (ptr->x_flag_min_function_alignment)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_min_function_alignment",
             ptr->x_flag_min_function_alignment);

  if (ptr->x_flag_openmp_target_simd_clone)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_openmp_target_simd_clone",
             ptr->x_flag_openmp_target_simd_clone);
  ...
  fprintf (file, "%*s%s (%#x)\n",
           ...
           (int) ptr->x_flag_harden_control_flow_redundancy_check_noreturn);

  fprintf (file, "%*s%s (%#x)\n",
           indent_to, "",
           "flag_inline_stringops",
           (int) ptr->x_flag_inline_stringops);
  ...
  if (ptr->x_flag_fold_mem_offsets)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_fold_mem_offsets",
             ptr->x_flag_fold_mem_offsets);
  ...
  if (ptr->x_flag_harden_control_flow_redundancy_check_exceptions)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_harden_control_flow_redundancy_check_exceptions",
             ptr->x_flag_harden_control_flow_redundancy_check_exceptions);

  if (ptr->x_flag_harden_control_flow_redundancy_check_returning_calls)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_harden_control_flow_redundancy_check_returning_calls",
             ptr->x_flag_harden_control_flow_redundancy_check_returning_calls);

  if (ptr->x_flag_harden_control_flow_redundancy_skip_leaf)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_harden_control_flow_redundancy_skip_leaf",
             ptr->x_flag_harden_control_flow_redundancy_skip_leaf);
  ...
  if (ptr->x_flag_harden_control_flow_redundancy)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_harden_control_flow_redundancy",
             ptr->x_flag_harden_control_flow_redundancy);
  ...
  if (ptr->x_flag_unreachable_traps)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_unreachable_traps",
             ptr->x_flag_unreachable_traps);
                            ...
                            struct cl_optimization *ptr2)
{
  ...
  if (ptr1->x_param_asan_kernel_mem_intrinsic_prefix != ptr2->x_param_asan_kernel_mem_intrinsic_prefix)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_asan_kernel_mem_intrinsic_prefix",
             ptr1->x_param_asan_kernel_mem_intrinsic_prefix,
             ptr2->x_param_asan_kernel_mem_intrinsic_prefix);
  ...
  if (ptr1->x_param_fully_pipelined_fma != ptr2->x_param_fully_pipelined_fma)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_fully_pipelined_fma",
             ptr1->x_param_fully_pipelined_fma,
             ptr2->x_param_fully_pipelined_fma);
  ...
  if (ptr1->x_param_hardcfr_max_blocks != ptr2->x_param_hardcfr_max_blocks)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_hardcfr_max_blocks",
             ptr1->x_param_hardcfr_max_blocks,
             ptr2->x_param_hardcfr_max_blocks);

  if (ptr1->x_param_hardcfr_max_inline_blocks != ptr2->x_param_hardcfr_max_inline_blocks)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_hardcfr_max_inline_blocks",
             ptr1->x_param_hardcfr_max_inline_blocks,
             ptr2->x_param_hardcfr_max_inline_blocks);
  ...
  if (ptr1->x_param_ipa_sra_deref_prob_threshold != ptr2->x_param_ipa_sra_deref_prob_threshold)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_ipa_sra_deref_prob_threshold",
             ptr1->x_param_ipa_sra_deref_prob_threshold,
             ptr2->x_param_ipa_sra_deref_prob_threshold);
  ...
  if (ptr1->x_param_ipa_sra_ptrwrap_growth_factor != ptr2->x_param_ipa_sra_ptrwrap_growth_factor)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_ipa_sra_ptrwrap_growth_factor",
             ptr1->x_param_ipa_sra_ptrwrap_growth_factor,
             ptr2->x_param_ipa_sra_ptrwrap_growth_factor);
  ...
  if (ptr1->x_param_ira_simple_lra_insn_threshold != ptr2->x_param_ira_simple_lra_insn_threshold)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_ira_simple_lra_insn_threshold",
             ptr1->x_param_ira_simple_lra_insn_threshold,
             ptr2->x_param_ira_simple_lra_insn_threshold);
  ...
  if (ptr1->x_param_max_jump_thread_paths != ptr2->x_param_max_jump_thread_paths)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_max_jump_thread_paths",
             ptr1->x_param_max_jump_thread_paths,
             ptr2->x_param_max_jump_thread_paths);
  ...
  if (ptr1->x_param_max_unswitch_depth != ptr2->x_param_max_unswitch_depth)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_max_unswitch_depth",
             ptr1->x_param_max_unswitch_depth,
             ptr2->x_param_max_unswitch_depth);
  ...
  if (ptr1->x_param_ranger_recompute_depth != ptr2->x_param_ranger_recompute_depth)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_ranger_recompute_depth",
             ptr1->x_param_ranger_recompute_depth,
             ptr2->x_param_ranger_recompute_depth);
  ...
  if (ptr1->x_param_uninit_max_chain_len != ptr2->x_param_uninit_max_chain_len)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_uninit_max_chain_len",
             ptr1->x_param_uninit_max_chain_len,
             ptr2->x_param_uninit_max_chain_len);

  if (ptr1->x_param_uninit_max_num_chains != ptr2->x_param_uninit_max_num_chains)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_uninit_max_num_chains",
             ptr1->x_param_uninit_max_num_chains,
             ptr2->x_param_uninit_max_num_chains);
  ...
  if (ptr1->x_param_vect_max_layout_candidates != ptr2->x_param_vect_max_layout_candidates)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_vect_max_layout_candidates",
             ptr1->x_param_vect_max_layout_candidates,
             ptr2->x_param_vect_max_layout_candidates);
  ...
  if (ptr1->x_param_vrp_sparse_threshold != ptr2->x_param_vrp_sparse_threshold)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_vrp_sparse_threshold",
             ptr1->x_param_vrp_sparse_threshold,
             ptr2->x_param_vrp_sparse_threshold);

  if (ptr1->x_param_vrp_switch_limit != ptr2->x_param_vrp_switch_limit)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_vrp_switch_limit",
             ptr1->x_param_vrp_switch_limit,
             ptr2->x_param_vrp_switch_limit);

  if (ptr1->x_param_vrp_vector_threshold != ptr2->x_param_vrp_vector_threshold)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_vrp_vector_threshold",
             ptr1->x_param_vrp_vector_threshold,
             ptr2->x_param_vrp_vector_threshold);

  if (ptr1->x_flag_min_function_alignment != ptr2->x_flag_min_function_alignment)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_min_function_alignment",
             ptr1->x_flag_min_function_alignment,
             ptr2->x_flag_min_function_alignment);

  if (ptr1->x_flag_openmp_target_simd_clone != ptr2->x_flag_openmp_target_simd_clone)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_openmp_target_simd_clone",
             ptr1->x_flag_openmp_target_simd_clone,
             ptr2->x_flag_openmp_target_simd_clone);
  ...
  if (ptr1->x_flag_harden_control_flow_redundancy_check_noreturn != ptr2->x_flag_harden_control_flow_redundancy_check_noreturn)
  fprintf (file, "%*s%s (%#x/%#x)\n",
           indent_to, "",
           "flag_harden_control_flow_redundancy_check_noreturn",
           (int) ptr1->x_flag_harden_control_flow_redundancy_check_noreturn,
           (int) ptr2->x_flag_harden_control_flow_redundancy_check_noreturn);

  if (ptr1->x_flag_inline_stringops != ptr2->x_flag_inline_stringops)
  fprintf (file, "%*s%s (%#x/%#x)\n",
           indent_to, "",
           "flag_inline_stringops",
           (int) ptr1->x_flag_inline_stringops,
           (int) ptr2->x_flag_inline_stringops);
  ...
  if (ptr1->x_flag_fold_mem_offsets != ptr2->x_flag_fold_mem_offsets)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_fold_mem_offsets",
             ptr1->x_flag_fold_mem_offsets,
             ptr2->x_flag_fold_mem_offsets);
  ...
  if (ptr1->x_flag_harden_control_flow_redundancy_check_exceptions != ptr2->x_flag_harden_control_flow_redundancy_check_exceptions)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_harden_control_flow_redundancy_check_exceptions",
             ptr1->x_flag_harden_control_flow_redundancy_check_exceptions,
             ptr2->x_flag_harden_control_flow_redundancy_check_exceptions);

  if (ptr1->x_flag_harden_control_flow_redundancy_check_returning_calls != ptr2->x_flag_harden_control_flow_redundancy_check_returning_calls)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_harden_control_flow_redundancy_check_returning_calls",
             ptr1->x_flag_harden_control_flow_redundancy_check_returning_calls,
             ptr2->x_flag_harden_control_flow_redundancy_check_returning_calls);

  if (ptr1->x_flag_harden_control_flow_redundancy_skip_leaf != ptr2->x_flag_harden_control_flow_redundancy_skip_leaf)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_harden_control_flow_redundancy_skip_leaf",
             ptr1->x_flag_harden_control_flow_redundancy_skip_leaf,
             ptr2->x_flag_harden_control_flow_redundancy_skip_leaf);
  ...
  if (ptr1->x_flag_harden_control_flow_redundancy != ptr2->x_flag_harden_control_flow_redundancy)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_harden_control_flow_redundancy",
             ptr1->x_flag_harden_control_flow_redundancy,
             ptr2->x_flag_harden_control_flow_redundancy);
  ...
  if (ptr1->x_flag_unreachable_traps != ptr2->x_flag_unreachable_traps)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_unreachable_traps",
             ptr1->x_flag_unreachable_traps,
             ptr2->x_flag_unreachable_traps);
...
cl_optimization_hash (struct cl_optimization const *ptr ATTRIBUTE_UNUSED)
{
  ...
  hstate.add_hwi (ptr->x_param_asan_kernel_mem_intrinsic_prefix);
  ...
  hstate.add_hwi (ptr->x_param_fully_pipelined_fma);
  ...
  hstate.add_hwi (ptr->x_param_hardcfr_max_blocks);
  hstate.add_hwi (ptr->x_param_hardcfr_max_inline_blocks);
  ...
  hstate.add_hwi (ptr->x_param_ipa_sra_deref_prob_threshold);
  hstate.add_hwi (ptr->x_param_ipa_sra_max_replacements);
  hstate.add_hwi (ptr->x_param_ipa_sra_ptr_growth_factor);
  hstate.add_hwi (ptr->x_param_ipa_sra_ptrwrap_growth_factor);
  ...
  hstate.add_hwi (ptr->x_param_ira_simple_lra_insn_threshold);
  ...
  hstate.add_hwi (ptr->x_param_max_jump_thread_paths);
  ...
  hstate.add_hwi (ptr->x_param_max_unswitch_depth);
  ...
  hstate.add_hwi (ptr->x_param_ranger_recompute_depth);
  ...
  hstate.add_hwi (ptr->x_param_uninit_max_chain_len);
  hstate.add_hwi (ptr->x_param_uninit_max_num_chains);
  ...
  hstate.add_hwi (ptr->x_param_vect_max_layout_candidates);
  ...
  hstate.add_hwi (ptr->x_param_vrp_sparse_threshold);
  hstate.add_hwi (ptr->x_param_vrp_switch_limit);
  hstate.add_hwi (ptr->x_param_vrp_vector_threshold);
  ...
  hstate.add_hwi (ptr->x_flag_fold_mem_offsets);
  ...
  hstate.add_hwi (ptr->x_flag_harden_control_flow_redundancy_check_exceptions);
  hstate.add_hwi (ptr->x_flag_harden_control_flow_redundancy_check_noreturn);
  hstate.add_hwi (ptr->x_flag_harden_control_flow_redundancy_check_returning_calls);
  hstate.add_hwi (ptr->x_flag_harden_control_flow_redundancy_skip_leaf);
  hstate.add_hwi (ptr->x_flag_harden_compares);
  hstate.add_hwi (ptr->x_flag_harden_conditional_branches);
  hstate.add_hwi (ptr->x_flag_harden_control_flow_redundancy);
  ...
  hstate.add_hwi (ptr->x_flag_inline_stringops);
  ...
  hstate.add_hwi (ptr->x_flag_min_function_alignment);
  ...
  hstate.add_hwi (ptr->x_flag_openmp_target_simd_clone);
  ...
  hstate.add_hwi (ptr->x_flag_unreachable_traps);
                            ...
                            struct cl_optimization *ptr)
{
  ...
  if (0 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_asan_kernel_mem_intrinsic_prefix ^ 0);
  else
    bp_pack_var_len_int (bp, ptr->x_param_asan_kernel_mem_intrinsic_prefix);
  if (1 > (int ) 10)
  ...
  if (0 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_fully_pipelined_fma ^ 0);
  else
    bp_pack_var_len_int (bp, ptr->x_param_fully_pipelined_fma);
  if (10 > (int ) 10)
  ...
  if (0 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_hardcfr_max_blocks ^ 0);
  else
    bp_pack_var_len_int (bp, ptr->x_param_hardcfr_max_blocks);
  if (16 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_hardcfr_max_inline_blocks ^ 16);
  else
    bp_pack_var_len_int (bp, ptr->x_param_hardcfr_max_inline_blocks);
  if (1 > (int ) 10)
  ...
  if (50 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_ipa_sra_deref_prob_threshold ^ 50);
  else
    bp_pack_var_len_int (bp, ptr->x_param_ipa_sra_deref_prob_threshold);
  if (8 > (int ) 10)
  ...
  if (4 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_ipa_sra_ptrwrap_growth_factor ^ 4);
  else
    bp_pack_var_len_int (bp, ptr->x_param_ipa_sra_ptrwrap_growth_factor);
  if (1 > (int ) 10)
  ...
  if (1000 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_ira_simple_lra_insn_threshold ^ 1000);
  else
    bp_pack_var_len_int (bp, ptr->x_param_ira_simple_lra_insn_threshold);
  if (10 > (int ) 10)
  ...
  if (64 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_max_jump_thread_paths ^ 64);
  else
    bp_pack_var_len_int (bp, ptr->x_param_max_jump_thread_paths);
  if (10000 > (int ) 10)
  ...
  if (50 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_max_unswitch_depth ^ 50);
  else
    bp_pack_var_len_int (bp, ptr->x_param_max_unswitch_depth);
  if (50 > (int ) 10)
  ...
  if (5 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_ranger_recompute_depth ^ 5);
  else
    bp_pack_var_len_int (bp, ptr->x_param_ranger_recompute_depth);
  if (200 > (int ) 10)
  ...
  if (8 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_uninit_max_chain_len ^ 8);
  else
    bp_pack_var_len_int (bp, ptr->x_param_uninit_max_chain_len);
  if (8 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_uninit_max_num_chains ^ 8);
  else
    bp_pack_var_len_int (bp, ptr->x_param_uninit_max_num_chains);
  if (2 > (int ) 10)
  ...
  if (32 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_vect_max_layout_candidates ^ 32);
  else
    bp_pack_var_len_int (bp, ptr->x_param_vect_max_layout_candidates);
  if (-1 > (int ) 10)
  ...
  if (3000 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_vrp_sparse_threshold ^ 3000);
  else
    bp_pack_var_len_int (bp, ptr->x_param_vrp_sparse_threshold);
  if (50 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_vrp_switch_limit ^ 50);
  else
    bp_pack_var_len_int (bp, ptr->x_param_vrp_switch_limit);
  if (250 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_vrp_vector_threshold ^ 250);
  else
    bp_pack_var_len_int (bp, ptr->x_param_vrp_vector_threshold);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_fold_mem_offsets);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_harden_control_flow_redundancy_check_exceptions);
  bp_pack_var_len_int (bp, ptr->x_flag_harden_control_flow_redundancy_check_noreturn);
  bp_pack_var_len_int (bp, ptr->x_flag_harden_control_flow_redundancy_check_returning_calls);
  bp_pack_var_len_int (bp, ptr->x_flag_harden_control_flow_redundancy_skip_leaf);
  bp_pack_var_len_int (bp, ptr->x_flag_harden_compares);
  bp_pack_var_len_int (bp, ptr->x_flag_harden_conditional_branches);
  bp_pack_var_len_int (bp, ptr->x_flag_harden_control_flow_redundancy);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_inline_stringops);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_min_function_alignment);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_openmp_target_simd_clone);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_unreachable_traps);
                           ...
                           struct cl_optimization *ptr ATTRIBUTE_UNUSED)
{
  ...
  ptr->x_param_asan_kernel_mem_intrinsic_prefix = (int ) bp_unpack_var_len_int (bp);
  if (0 > (int ) 10)
    ptr->x_param_asan_kernel_mem_intrinsic_prefix ^= 0;
  ...
  ptr->x_param_fully_pipelined_fma = (int ) bp_unpack_var_len_int (bp);
  if (0 > (int ) 10)
    ptr->x_param_fully_pipelined_fma ^= 0;
  ...
  ptr->x_param_hardcfr_max_blocks = (int ) bp_unpack_var_len_int (bp);
  if (0 > (int ) 10)
    ptr->x_param_hardcfr_max_blocks ^= 0;
  ptr->x_param_hardcfr_max_inline_blocks = (int ) bp_unpack_var_len_int (bp);
  if (16 > (int ) 10)
    ptr->x_param_hardcfr_max_inline_blocks ^= 16;
  ...
  ptr->x_param_ipa_sra_deref_prob_threshold = (int ) bp_unpack_var_len_int (bp);
  if (50 > (int ) 10)
    ptr->x_param_ipa_sra_deref_prob_threshold ^= 50;
  ...
  ptr->x_param_ipa_sra_ptrwrap_growth_factor = (int ) bp_unpack_var_len_int (bp);
  if (4 > (int ) 10)
    ptr->x_param_ipa_sra_ptrwrap_growth_factor ^= 4;
  ...
  ptr->x_param_ira_simple_lra_insn_threshold = (int ) bp_unpack_var_len_int (bp);
  if (1000 > (int ) 10)
    ptr->x_param_ira_simple_lra_insn_threshold ^= 1000;
  ...
  ptr->x_param_max_jump_thread_paths = (int ) bp_unpack_var_len_int (bp);
  if (64 > (int ) 10)
    ptr->x_param_max_jump_thread_paths ^= 64;
  ...
  ptr->x_param_max_unswitch_depth = (int ) bp_unpack_var_len_int (bp);
  if (50 > (int ) 10)
    ptr->x_param_max_unswitch_depth ^= 50;
  ...
  ptr->x_param_ranger_recompute_depth = (int ) bp_unpack_var_len_int (bp);
  if (5 > (int ) 10)
    ptr->x_param_ranger_recompute_depth ^= 5;
  ...
  ptr->x_param_uninit_max_chain_len = (int ) bp_unpack_var_len_int (bp);
  if (8 > (int ) 10)
    ptr->x_param_uninit_max_chain_len ^= 8;
  ptr->x_param_uninit_max_num_chains = (int ) bp_unpack_var_len_int (bp);
  if (8 > (int ) 10)
    ptr->x_param_uninit_max_num_chains ^= 8;
  ...
  ptr->x_param_vect_max_layout_candidates = (int ) bp_unpack_var_len_int (bp);
  if (32 > (int ) 10)
    ptr->x_param_vect_max_layout_candidates ^= 32;
  ...
  ptr->x_param_vrp_sparse_threshold = (int ) bp_unpack_var_len_int (bp);
  if (3000 > (int ) 10)
    ptr->x_param_vrp_sparse_threshold ^= 3000;
  ptr->x_param_vrp_switch_limit = (int ) bp_unpack_var_len_int (bp);
  if (50 > (int ) 10)
    ptr->x_param_vrp_switch_limit ^= 50;
  ptr->x_param_vrp_vector_threshold = (int ) bp_unpack_var_len_int (bp);
  if (250 > (int ) 10)
    ptr->x_param_vrp_vector_threshold ^= 250;
  ...
  ptr->x_flag_fold_mem_offsets = (signed char ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_harden_control_flow_redundancy_check_exceptions = (signed char ) bp_unpack_var_len_int (bp);
  ptr->x_flag_harden_control_flow_redundancy_check_noreturn = (enum hardcfr_noret ) bp_unpack_var_len_int (bp);
  ptr->x_flag_harden_control_flow_redundancy_check_returning_calls = (signed char ) bp_unpack_var_len_int (bp);
  ptr->x_flag_harden_control_flow_redundancy_skip_leaf = (signed char ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_harden_control_flow_redundancy = (signed char ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_inline_stringops = (enum ilsop_fn ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_min_function_alignment = (int ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_openmp_target_simd_clone = (int ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_unreachable_traps = (signed char ) bp_unpack_var_len_int (bp);
...
cl_optimization_compare (gcc_options *ptr1, gcc_options *ptr2)
{
  ...
  if (ptr1->x_param_analyzer_min_snodes_for_call_summary != ptr2->x_param_analyzer_min_snodes_for_call_summary)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_analyzer_text_art_ideal_canvas_width != ptr2->x_param_analyzer_text_art_ideal_canvas_width)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_analyzer_text_art_string_ellipsis_head_len != ptr2->x_param_analyzer_text_art_string_ellipsis_head_len)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_analyzer_text_art_string_ellipsis_tail_len != ptr2->x_param_analyzer_text_art_string_ellipsis_tail_len)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_analyzer_text_art_string_ellipsis_threshold != ptr2->x_param_analyzer_text_art_string_ellipsis_threshold)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_aligned_new != ptr2->x_warn_aligned_new)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_alloc_size != ptr2->x_warn_alloc_size)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_ampersand != ptr2->x_warn_ampersand)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_allocation_size != ptr2->x_warn_analyzer_allocation_size)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_deref_before_check != ptr2->x_warn_analyzer_deref_before_check)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_analyzer_exposure_through_output_file != ptr2->x_warn_analyzer_exposure_through_output_file)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_exposure_through_uninit_copy != ptr2->x_warn_analyzer_exposure_through_uninit_copy)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_fd_mode_mismatch != ptr2->x_warn_analyzer_fd_mode_mismatch)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_fd_double_close != ptr2->x_warn_analyzer_fd_double_close)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_fd_leak != ptr2->x_warn_analyzer_fd_leak)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_fd_phase_mismatch != ptr2->x_warn_analyzer_fd_phase_mismatch)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_fd_type_mismatch != ptr2->x_warn_analyzer_fd_type_mismatch)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_fd_use_after_close != ptr2->x_warn_analyzer_fd_use_after_close)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_fd_use_without_check != ptr2->x_warn_analyzer_fd_use_without_check)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_analyzer_free_of_non_heap != ptr2->x_warn_analyzer_free_of_non_heap)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_imprecise_fp_arithmetic != ptr2->x_warn_analyzer_imprecise_fp_arithmetic)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_infinite_loop != ptr2->x_warn_analyzer_infinite_loop)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_infinite_recursion != ptr2->x_warn_analyzer_infinite_recursion)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_jump_through_null != ptr2->x_warn_analyzer_jump_through_null)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_analyzer_null_dereference != ptr2->x_warn_analyzer_null_dereference)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_out_of_bounds != ptr2->x_warn_analyzer_out_of_bounds)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_overlapping_buffers != ptr2->x_warn_analyzer_overlapping_buffers)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_analyzer_possible_null_dereference != ptr2->x_warn_analyzer_possible_null_dereference)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_putenv_of_auto_var != ptr2->x_warn_analyzer_putenv_of_auto_var)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_analyzer_stale_setjmp_buffer != ptr2->x_warn_analyzer_stale_setjmp_buffer)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_symbol_too_complex != ptr2->x_warn_analyzer_symbol_too_complex)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_analyzer_tainted_array_index != ptr2->x_warn_analyzer_tainted_array_index)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_tainted_assertion != ptr2->x_warn_analyzer_tainted_assertion)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_analyzer_too_complex != ptr2->x_warn_analyzer_too_complex)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_undefined_behavior_strtok != ptr2->x_warn_analyzer_undefined_behavior_strtok)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_cxx23_extensions != ptr2->x_warn_cxx23_extensions)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_cxx26_extensions != ptr2->x_warn_cxx26_extensions)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_c_binding_type != ptr2->x_warn_c_binding_type)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_c11_c23_compat != ptr2->x_warn_c11_c23_compat)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_c90_c99_compat != ptr2->x_warn_c90_c99_compat)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_c99_c11_compat != ptr2->x_warn_c99_c11_compat)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_calloc_transposed_args != ptr2->x_warn_calloc_transposed_args)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_cast_result != ptr2->x_warn_cast_result)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_cast_user_defined != ptr2->x_warn_cast_user_defined)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_catch_value != ptr2->x_warn_catch_value)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_changes_meaning != ptr2->x_warn_changes_meaning)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_cpp_warn_comment != ptr2->x_cpp_warn_comment)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_compare_distinct_pointer_types != ptr2->x_warn_compare_distinct_pointer_types)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_compare_reals != ptr2->x_warn_compare_reals)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_complain_wrong_lang != ptr2->x_warn_complain_wrong_lang)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_coverage_mismatch != ptr2->x_warn_coverage_mismatch)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_too_many_conditions != ptr2->x_warn_too_many_conditions)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_dangling_pointer != ptr2->x_warn_dangling_pointer)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_dangling_reference != ptr2->x_warn_dangling_reference)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_declaration_after_statement != ptr2->x_warn_declaration_after_statement)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_declaration_missing_parameter != ptr2->x_warn_declaration_missing_parameter)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_ecpp != ptr2->x_warn_ecpp)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_elaborated_enum_base != ptr2->x_warn_elaborated_enum_base)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_fatal_errors != ptr2->x_flag_fatal_errors)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_flex_array_member_not_at_end != ptr2->x_warn_flex_array_member_not_at_end)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_function_elimination != ptr2->x_warn_function_elimination)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_global_module != ptr2->x_warn_global_module)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_hardened != ptr2->x_warn_hardened)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_intrinsics_std != ptr2->x_warn_intrinsics_std)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_invalid_constexpr != ptr2->x_warn_invalid_constexpr)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_cpp_warn_invalid_pch != ptr2->x_cpp_warn_invalid_pch)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_invalid_utf8 != ptr2->x_warn_invalid_utf8)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_mismatched_new_delete != ptr2->x_warn_mismatched_new_delete)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_mismatched_special_enum != ptr2->x_warn_mismatched_special_enum)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_missing_template_keyword != ptr2->x_warn_missing_template_keyword)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_missing_variable_declarations != ptr2->x_warn_missing_variable_declarations)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_cpp_warn_normalize != ptr2->x_cpp_warn_normalize)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_nrvo != ptr2->x_warn_nrvo)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_openacc_parallelism != ptr2->x_warn_openacc_parallelism)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_openmp != ptr2->x_warn_openmp)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_return_local_addr != ptr2->x_warn_return_local_addr)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_return_mismatch != ptr2->x_warn_return_mismatch)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_selector != ptr2->x_warn_selector)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_self_move != ptr2->x_warn_self_move)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_strict_aliasing != ptr2->x_warn_strict_aliasing)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_strict_flex_arrays != ptr2->x_warn_strict_flex_arrays)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_suggest_attribute_pure != ptr2->x_warn_suggest_attribute_pure)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_suggest_attribute_returns_nonnull != ptr2->x_warn_suggest_attribute_returns_nonnull)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_tautological_compare != ptr2->x_warn_tautological_compare)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_template_id_cdtor != ptr2->x_warn_template_id_cdtor)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_underflow != ptr2->x_warn_underflow)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_unicode != ptr2->x_warn_unicode)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_write_strings != ptr2->x_warn_write_strings)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_xor_used_as_pow != ptr2->x_warn_xor_used_as_pow)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_analyzer_checker != ptr2->x_flag_analyzer_checker)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_analyzer_debug_text_art != ptr2->x_flag_analyzer_debug_text_art)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_analyzer_show_duplicate_count != ptr2->x_flag_analyzer_show_duplicate_count)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_analyzer_show_events_in_system_headers != ptr2->x_flag_analyzer_show_events_in_system_headers)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_analyzer_state_purge != ptr2->x_flag_analyzer_state_purge)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_analyzer_suppress_followups != ptr2->x_flag_analyzer_suppress_followups)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_concepts_ts != ptr2->x_flag_concepts_ts)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_condition_coverage_flag != ptr2->x_condition_coverage_flag)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_conserve_stack != ptr2->x_flag_conserve_stack)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_constexpr_ops_limit != ptr2->x_constexpr_ops_limit)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_contract_mode != ptr2->x_flag_contract_mode)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_contract_strict_declarations != ptr2->x_flag_contract_strict_declarations)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_contracts != ptr2->x_flag_contracts)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_devirtualize_speculatively != ptr2->x_flag_devirtualize_speculatively)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_diagnostics_all_candidates != ptr2->x_flag_diagnostics_all_candidates)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_diagnostics_generate_patch != ptr2->x_flag_diagnostics_generate_patch)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_diagnostics_json_formatting != ptr2->x_flag_diagnostics_json_formatting)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_diagnostics_show_path_depths != ptr2->x_flag_diagnostics_show_path_depths)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_diagnostics_show_rules != ptr2->x_flag_diagnostics_show_rules)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_diagnostics_show_template_tree != ptr2->x_flag_diagnostics_show_template_tree)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_diagnostics_text_art_charset != ptr2->x_flag_diagnostics_text_art_charset)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_dump_analyzer_feasibility != ptr2->x_flag_dump_analyzer_feasibility)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_dump_analyzer_infinite_loop != ptr2->x_flag_dump_analyzer_infinite_loop)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_harden_control_flow_redundancy != ptr2->x_flag_harden_control_flow_redundancy)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_hardened != ptr2->x_flag_hardened)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_hoist_adjacent_loads != ptr2->x_flag_hoist_adjacent_loads)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_if_conversion2 != ptr2->x_flag_if_conversion2)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_immediate_escalation != ptr2->x_flag_immediate_escalation)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_openmp != ptr2->x_flag_openmp)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_openmp_allocators != ptr2->x_flag_openmp_allocators)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_rtti != ptr2->x_flag_rtti)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_borrowcheck != ptr2->x_flag_borrowcheck)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_rust_compile_until != ptr2->x_flag_rust_compile_until)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_rust_crate_type != ptr2->x_flag_rust_crate_type)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_rust_debug != ptr2->x_flag_rust_debug)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_rust_edition != ptr2->x_flag_rust_edition)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_rust_embed_metadata != ptr2->x_flag_rust_embed_metadata)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_rust_experimental != ptr2->x_flag_rust_experimental)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_rust_mangling != ptr2->x_flag_rust_mangling)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_rust_max_recursion_depth != ptr2->x_rust_max_recursion_depth)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_name_resolution_2_0 != ptr2->x_flag_name_resolution_2_0)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_strict_enums != ptr2->x_flag_strict_enums)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_strict_flex_arrays != ptr2->x_flag_strict_flex_arrays)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_strict_volatile_bitfields != ptr2->x_flag_strict_volatile_bitfields)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_strong_eval_order != ptr2->x_flag_strong_eval_order)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_strub != ptr2->x_flag_strub)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_tracer != ptr2->x_flag_tracer)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_trampoline_impl != ptr2->x_flag_trampoline_impl)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_lto_dump_list != ptr2->x_flag_lto_dump_list)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_rx_allow_string_insns != ptr2->x_rx_allow_string_insns)
    internal_error ("%<global_options%> are modified in local context");
