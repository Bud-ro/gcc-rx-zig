...
#endif
  E_CC_ZSmode,             /* config/rx/rx-modes.def:21 */
#define HAVE_CC_ZSmode
#ifdef USE_ENUM_MODES
#define CC_ZSmode E_CC_ZSmode
#else
#define CC_ZSmode ((void) 0, E_CC_ZSmode)
#endif
  E_CC_ZSOmode,            /* config/rx/rx-modes.def:22 */
#define HAVE_CC_ZSOmode
#ifdef USE_ENUM_MODES
#define CC_ZSOmode E_CC_ZSOmode
#else
#define CC_ZSOmode ((void) 0, E_CC_ZSOmode)
#endif
  E_CC_ZSCmode,            /* config/rx/rx-modes.def:23 */
#define HAVE_CC_ZSCmode
#ifdef USE_ENUM_MODES
#define CC_ZSCmode E_CC_ZSCmode
#else
#define CC_ZSCmode ((void) 0, E_CC_ZSCmode)
#endif
  E_CC_Fmode,              /* config/rx/rx-modes.def:25 */
#define HAVE_CC_Fmode
#ifdef USE_ENUM_MODES
#define CC_Fmode E_CC_Fmode
#else
#define CC_Fmode ((void) 0, E_CC_Fmode)
#endif
