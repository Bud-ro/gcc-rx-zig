  ...
  switch (option_index)
    {
     ...
     case OPT_fallocation_dce:
       return "gcc/Optimize-Options.html#index-fno-allocation-dce";
     ...
     case OPT_fconcepts_ts:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fconcepts-ts";
     ...
     case OPT_flang_info_module_cmi_:
       return "gcc/C_002b_002b-Dialect-Options.html#index-flang-info-module-cmi";
     case OPT_flarge_source_files:
       return "gcc/Preprocessor-Options.html#index-flarge-source-files";
     ...
     case OPT_fmodules_ts:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fmodules-ts";
     ...
     case OPT_foffload_options_:
       return "gcc/C-Dialect-Options.html#index-foffload-options";
     case OPT_foffload_:
       return "gcc/C-Dialect-Options.html#index-foffload";
     ...
     case OPT_fopenacc:
       ...
       return "gcc/C-Dialect-Options.html#index-fopenacc";
     case OPT_fopenacc_dim_:
       return "gcc/C-Dialect-Options.html#index-fopenacc-dim";
     case OPT_fopenmp:
       if (lang_mask & CL_Fortran)
         return "gfortran/Fortran-Dialect-Options.html#index-fopenmp";
       return "gcc/C-Dialect-Options.html#index-fopenmp";
     ...
     case OPT_fopenmp_simd:
       ...
       return "gcc/C-Dialect-Options.html#index-fopenmp-simd";
     case OPT_fopenmp_target_simd_clone_:
       return "gcc/C-Dialect-Options.html#index-fopenmp-target-simd-clone";
     ...
     case OPT_fpthread:
       break;
     case OPT_fpu:
       return "gcc/RX-Options.html#index-fpu";
     case OPT_fq:
       break;
     ...
     case OPT_freg_struct_return:
       return "gcc/Code-Gen-Options.html#index-freg-struct-return";
     case OPT_frelease:
       if (lang_mask & CL_D)
     ...
     case OPT_list:
       break;
     case OPT_m32bit_doubles:
       return "gcc/RX-Options.html#index-m32bit-doubles-1";
     case OPT_m64bit_doubles:
       return "gcc/RX-Options.html#index-m64bit-doubles-1";
     case OPT_mallow_string_insns:
       return "gcc/RX-Options.html#index-mallow-string-insns";
     case OPT_mas100_syntax:
       return "gcc/RX-Options.html#index-mas100-syntax";
     case OPT_mbig_endian_data:
