...
extern const struct ggc_root_tab gt_ggc_r_gt_rx_h[];
...
extern const struct ggc_root_tab gt_ggc_r_gt_m2_gm2_lang_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_m2_rtegraph_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_m2_m2block_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_m2_m2builtins_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_m2_m2decl_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_m2_m2except_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_m2_m2expr_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_m2_m2statement_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_m2_m2type_h[];
EXPORTED_CONST struct ggc_root_tab * const gt_ggc_rtab[] = {
  ...
  gt_ggc_r_gt_m2_gm2_lang_h,
  gt_ggc_r_gt_m2_rtegraph_h,
  gt_ggc_r_gt_m2_m2block_h,
  gt_ggc_r_gt_m2_m2builtins_h,
  gt_ggc_r_gt_m2_m2decl_h,
  gt_ggc_r_gt_m2_m2except_h,
  gt_ggc_r_gt_m2_m2expr_h,
  gt_ggc_r_gt_m2_m2statement_h,
  gt_ggc_r_gt_m2_m2type_h,
  NULL
};
