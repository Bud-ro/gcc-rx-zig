  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      {
        size_t l3 = (size_t)(((*x).m_location_adhoc_data_map).allocated);
        if ((*x).m_location_adhoc_data_map.data != NULL) {
          size_t i3;
          for (i3 = 0; i3 != (size_t)(l3); i3++) {
          }
          ggc_mark ((*x).m_location_adhoc_data_map.data);
        }
      }
    }
}
  ...
  while (x != xlimit)
    {
      switch ((int) (gimple_statement_structure (&((*x)))))
        ...
        case GSS_ASSUME:
          {
            gimple_statement_assume *sub = static_cast <gimple_statement_assume *> (x);
            gt_ggc_m_9tree_node ((*sub).guard);
...
void
gt_ggc_mx_vrange_storage (void *x_p)
{
  struct vrange_storage * const x = (struct vrange_storage *)x_p;
  if (ggc_test_and_set_mark (x))
    {
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_11bitmap_head ((*x).escaped_return.vars);
  ...
  while (x != xlimit)
    {
      ...
      gt_ggc_mx (&((*x).nb_iterations_upper_bound));
      gt_ggc_mx (&((*x).nb_iterations_likely_upper_bound));
      gt_ggc_mx (&((*x).nb_iterations_estimate));
...
void
gt_ggc_mx_ipa_vr (void *x_p)
{
  struct ipa_vr * const x = (struct ipa_vr *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_14vrange_storage ((*x).m_storage);
      gt_ggc_m_9tree_node ((*x).m_type);
    }
}
...
{
  hash_map<location_hash,nowarn_spec_t> * const x = (hash_map<location_hash,nowarn_spec_t> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
  ...
  while (x != xlimit)
    {
      ...
      switch ((int) (((*x).dw_loc_oprnd1).val_class))
        ...
        case dw_val_class_wide_int:
          gt_ggc_m_11dw_wide_int ((*x).dw_loc_oprnd1.v.val_wide);
          break;
      ...
      switch ((int) (((*x).dw_loc_oprnd2).val_class))
        ...
        case dw_val_class_const_double:
          break;
        case dw_val_class_wide_int:
          gt_ggc_m_11dw_wide_int ((*x).dw_loc_oprnd2.v.val_wide);
          break;
        case dw_val_class_vec:
...
void
gt_ggc_mx_dw_wide_int (void *x_p)
{
  struct dw_wide_int * const x = (struct dw_wide_int *)x_p;
  if (ggc_test_and_set_mark (x))
    {
    }
}
...
{
  hash_table<ctfc_dtd_hasher> * const x = (hash_table<ctfc_dtd_hasher> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
{
  hash_table<ctfc_dvd_hasher> * const x = (hash_table<ctfc_dvd_hasher> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
{
  struct eh_landing_pad_d * x = (struct eh_landing_pad_d *)x_p;
  struct eh_landing_pad_d * xlimit = x;
  while (ggc_test_and_set_mark (xlimit))
   xlimit = ((*xlimit).next_lp);
  while (x != xlimit)
    {
...
gt_ggc_mx_ipcp_transformation (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_27vec_ipa_argagg_value_va_gc_ ((*x).m_agg_values);
      gt_ggc_m_17vec_ipa_vr_va_gc_ ((*x).m_vr);
      gt_ggc_m_33vec_ipa_uid_to_idx_map_elt_va_gc_ ((*x).m_uid_to_idx);
    }
}
...
void
gt_ggc_mx_vec_ipa_argagg_value_va_gc_ (void *x_p)
{
  vec<ipa_argagg_value,va_gc> * const x = (vec<ipa_argagg_value,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct ipa_argagg_value& x_r ATTRIBUTE_UNUSED)
{
  struct ipa_argagg_value * ATTRIBUTE_UNUSED x = &x_r;
  gt_ggc_m_9tree_node ((*x).value);
}
...
void
gt_ggc_mx_vec_ipa_uid_to_idx_map_elt_va_gc_ (void *x_p)
{
  vec<ipa_uid_to_idx_map_elt,va_gc> * const x = (vec<ipa_uid_to_idx_map_elt,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct ipa_uid_to_idx_map_elt& x_r ATTRIBUTE_UNUSED)
{
  struct ipa_uid_to_idx_map_elt * ATTRIBUTE_UNUSED x = &x_r;
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9line_maps))
    {
      ...
      }
      {
        ...
        if ((*x).m_location_adhoc_data_map.data != NULL) {
          ...
          gt_pch_note_object ((*x).m_location_adhoc_data_map.data, x, gt_pch_p_9line_maps);
        }
      }
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9cpp_token))
    {
      switch ((int) (cpp_token_val_index (&((*x)))))
        ...
        case CPP_TOKEN_FLD_SOURCE:
          ...
          break;
        case CPP_TOKEN_FLD_STR:
          gt_pch_n_S2 ((*x).val.str.text, 1 + ((*x).val.str).len);
          break;
        case CPP_TOKEN_FLD_ARG_NO:
          {
            union tree_node * const x2 =
            ...
            for (i2 = 0; i2 != l2; i2++) {
              switch ((int) (cpp_token_val_index (&((*x).exp.tokens[i2]))))
                ...
                case CPP_TOKEN_FLD_SOURCE:
                  ...
                  break;
                case CPP_TOKEN_FLD_STR:
                  gt_pch_n_S2 ((*x).exp.tokens[i2].val.str.text, 1 + ((*x).exp.tokens[i2].val.str).len);
                  break;
                case CPP_TOKEN_FLD_ARG_NO:
                  {
                    union tree_node * const x5 =
...
void
gt_pch_nx_vrange_storage (void *x_p)
{
  struct vrange_storage * const x = (struct vrange_storage *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_14vrange_storage))
    {
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9gimple_df))
    {
      ...
      gt_pch_n_11bitmap_head ((*x).escaped_return.vars);
  ...
  while (x != xlimit)
    {
      ...
      gt_pch_nx (&((*x).nb_iterations_upper_bound));
      gt_pch_nx (&((*x).nb_iterations_likely_upper_bound));
      gt_pch_nx (&((*x).nb_iterations_estimate));
...
void
gt_pch_nx_ipa_vr (void *x_p)
{
  struct ipa_vr * const x = (struct ipa_vr *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_6ipa_vr))
    {
      gt_pch_n_14vrange_storage ((*x).m_storage);
      gt_pch_n_9tree_node ((*x).m_type);
    }
}
  ...
  while (x != xlimit)
    {
      ...
      switch ((int) (((*x).dw_loc_oprnd1).val_class))
        ...
        case dw_val_class_const_double:
          break;
        case dw_val_class_wide_int:
          gt_pch_n_11dw_wide_int ((*x).dw_loc_oprnd1.v.val_wide);
          break;
        case dw_val_class_vec:
          if ((*x).dw_loc_oprnd1.v.val_vec.array != NULL) {
      ...
      switch ((int) (((*x).dw_loc_oprnd2).val_class))
        ...
        case dw_val_class_const_double:
          break;
        case dw_val_class_wide_int:
          gt_pch_n_11dw_wide_int ((*x).dw_loc_oprnd2.v.val_wide);
          break;
        case dw_val_class_vec:
          if ((*x).dw_loc_oprnd2.v.val_vec.array != NULL) {
...
void
gt_pch_nx_dw_wide_int (void *x_p)
{
  struct dw_wide_int * const x = (struct dw_wide_int *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_11dw_wide_int))
    {
    }
}
...
gt_pch_nx_eh_landing_pad_d (void *x_p)
{
  struct eh_landing_pad_d * x = (struct eh_landing_pad_d *)x_p;
  struct eh_landing_pad_d * xlimit = x;
  while (gt_pch_note_object (xlimit, xlimit, gt_pch_p_16eh_landing_pad_d))
   xlimit = ((*xlimit).next_lp);
  while (x != xlimit)
    {
...
gt_pch_nx_ipcp_transformation (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_19ipcp_transformation))
    {
      gt_pch_n_27vec_ipa_argagg_value_va_gc_ ((*x).m_agg_values);
      gt_pch_n_17vec_ipa_vr_va_gc_ ((*x).m_vr);
      gt_pch_n_33vec_ipa_uid_to_idx_map_elt_va_gc_ ((*x).m_uid_to_idx);
    }
}
...
void
gt_pch_nx_vec_ipa_argagg_value_va_gc_ (void *x_p)
{
  vec<ipa_argagg_value,va_gc> * const x = (vec<ipa_argagg_value,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_27vec_ipa_argagg_value_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct ipa_argagg_value& x_r ATTRIBUTE_UNUSED)
{
  struct ipa_argagg_value * ATTRIBUTE_UNUSED x = &x_r;
  gt_pch_n_9tree_node ((*x).value);
}
...
void
gt_pch_nx_vec_ipa_uid_to_idx_map_elt_va_gc_ (void *x_p)
{
  vec<ipa_uid_to_idx_map_elt,va_gc> * const x = (vec<ipa_uid_to_idx_map_elt,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_33vec_ipa_uid_to_idx_map_elt_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct ipa_uid_to_idx_map_elt& x_r ATTRIBUTE_UNUSED)
{
  struct ipa_uid_to_idx_map_elt * ATTRIBUTE_UNUSED x = &x_r;
}
    ...
    if ((*x).info_ordinary.maps != NULL) {
      ...
      for (i0 = 0; i0 != (size_t)(l0) && ((void *)(*x).info_ordinary.maps == this_obj); i0++) {
        if ((void *)((*x).info_ordinary.maps) == this_obj)
          op (&((*x).info_ordinary.maps[i0].to_file), NULL, cookie);
      }
      if ((void *)(x) == this_obj)
        op (&((*x).info_ordinary.maps), NULL, cookie);
    }
  }
  {
    size_t l1 = (size_t)(((*x).info_macro).used);
      ...
      for (i1 = 0; i1 != (size_t)(l1) && ((void *)(*x).info_macro.maps == this_obj); i1++) {
        {
          ...
          if ((void *)((*x).info_macro.maps) == this_obj)
            op (&(x2), &((*x).info_macro.maps[i1].macro), cookie);
          (*x).info_macro.maps[i1].macro = (x2) ? CPP_HASHNODE (GCC_IDENT_TO_HT_IDENT ((x2))) : NULL;
        }
        if ((*x).info_macro.maps[i1].macro_locations != NULL) {
          if ((void *)((*x).info_macro.maps) == this_obj)
            op (&((*x).info_macro.maps[i1].macro_locations), NULL, cookie);
        }
      }
      if ((void *)(x) == this_obj)
        op (&((*x).info_macro.maps), NULL, cookie);
    }
  }
  if ((void *)(x) == this_obj)
    gt_pch_note_callback (&((*x).m_reallocator), this_obj);
  if ((void *)(x) == this_obj)
    gt_pch_note_callback (&((*x).m_round_alloc_size), this_obj);
  {
    size_t l3 = (size_t)(((*x).m_location_adhoc_data_map).allocated);
    if ((*x).m_location_adhoc_data_map.data != NULL) {
      size_t i3;
      for (i3 = 0; i3 != (size_t)(l3) && ((void *)(*x).m_location_adhoc_data_map.data == this_obj); i3++) {
      }
      if ((void *)(x) == this_obj)
        op (&((*x).m_location_adhoc_data_map.data), NULL, cookie);
    }
  }
}
    ...
    case CPP_TOKEN_FLD_NODE:
      ...
      }
      {
        union tree_node * x1 =
          ((*x).val.node.spelling) ? HT_IDENT_TO_GCC_IDENT (HT_NODE (((*x).val.node.spelling))) : NULL;
        if ((void *)(x) == this_obj)
          op (&(x1), &((*x).val.node.spelling), cookie);
        (*x).val.node.spelling = (x1) ? CPP_HASHNODE (GCC_IDENT_TO_HT_IDENT ((x1))) : NULL;
      }
      break;
    case CPP_TOKEN_FLD_SOURCE:
      if ((void *)(x) == this_obj)
        op (&((*x).val.source), NULL, cookie);
      break;
    case CPP_TOKEN_FLD_STR:
      if ((void *)(x) == this_obj)
        op (&((*x).val.str.text), NULL, cookie);
      break;
    case CPP_TOKEN_FLD_ARG_NO:
      {
        union tree_node * x2 =
          ((*x).val.macro_arg.spelling) ? HT_IDENT_TO_GCC_IDENT (HT_NODE (((*x).val.macro_arg.spelling))) : NULL;
        if ((void *)(x) == this_obj)
          op (&(x2), &((*x).val.macro_arg.spelling), cookie);
        ...
        for (i0 = 0; i0 != (size_t)(((*x)).paramc) && ((void *)(*x).parm.params == this_obj); i0++) {
          {
            ...
            if ((void *)((*x).parm.params) == this_obj)
              op (&(x1), &((*x).parm.params[i0]), cookie);
            (*x).parm.params[i0] = (x1) ? CPP_HASHNODE (GCC_IDENT_TO_HT_IDENT ((x1))) : NULL;
          }
        }
        if ((void *)(x) == this_obj)
          op (&((*x).parm.params), NULL, cookie);
      }
      break;
    case true:
      if ((void *)(x) == this_obj)
        op (&((*x).parm.next), NULL, cookie);
      break;
    default:
      break;
    }
            ...
            case CPP_TOKEN_FLD_NODE:
              {
                union tree_node * x3 =
                  ((*x).exp.tokens[i2].val.node.node) ? HT_IDENT_TO_GCC_IDENT (HT_NODE (((*x).exp.tokens[i2].val.node.node))) : NULL;
                if ((void *)(x) == this_obj)
                  op (&(x3), &((*x).exp.tokens[i2].val.node.node), cookie);
              ...
              }
              {
                union tree_node * x4 =
                  ((*x).exp.tokens[i2].val.node.spelling) ? HT_IDENT_TO_GCC_IDENT (HT_NODE (((*x).exp.tokens[i2].val.node.spelling))) : NULL;
                if ((void *)(x) == this_obj)
                  op (&(x4), &((*x).exp.tokens[i2].val.node.spelling), cookie);
                (*x).exp.tokens[i2].val.node.spelling = (x4) ? CPP_HASHNODE (GCC_IDENT_TO_HT_IDENT ((x4))) : NULL;
              }
              break;
            case CPP_TOKEN_FLD_SOURCE:
              if ((void *)(x) == this_obj)
                op (&((*x).exp.tokens[i2].val.source), NULL, cookie);
              break;
            case CPP_TOKEN_FLD_STR:
              if ((void *)(x) == this_obj)
                op (&((*x).exp.tokens[i2].val.str.text), NULL, cookie);
              break;
            case CPP_TOKEN_FLD_ARG_NO:
              {
                union tree_node * x5 =
                  ((*x).exp.tokens[i2].val.macro_arg.spelling) ? HT_IDENT_TO_GCC_IDENT (HT_NODE (((*x).exp.tokens[i2].val.macro_arg.spelling))) : NULL;
                if ((void *)(x) == this_obj)
                  op (&(x5), &((*x).exp.tokens[i2].val.macro_arg.spelling), cookie);
  ...
  switch ((int) (0))
    ...
    case 0:
      switch ((int) (GET_CODE (&(*x))))
        ...
        case DEBUG_PARAMETER_REF:
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[0].rt_tree), NULL, cookie);
          break;
        case ENTRY_VALUE:
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[0].rt_rtx), NULL, cookie);
          break;
        case DEBUG_IMPLICIT_PTR:
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[0].rt_tree), NULL, cookie);
        ...
        case VAR_LOCATION:
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[1].rt_rtx), NULL, cookie);
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[0].rt_tree), NULL, cookie);
          break;
        case COPYSIGN:
        ...
        case SYMBOL_REF:
          switch ((int) (SYMBOL_REF_HAS_BLOCK_INFO_P (&(*x))))
            ...
            case 1:
              if ((void *)(x) == this_obj)
                op (&((*x).u.block_sym.block), NULL, cookie);
              break;
            default:
              break;
            }
          switch ((int) (CONSTANT_POOL_ADDRESS_P (&(*x))))
            ...
            case 1:
              if ((void *)(x) == this_obj)
                op (&((*x).u.fld[1].rt_constant), NULL, cookie);
              break;
            default:
              if ((void *)(x) == this_obj)
                op (&((*x).u.fld[1].rt_tree), NULL, cookie);
              break;
            }
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[0].rt_str), NULL, cookie);
          break;
        case LABEL_REF:
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[0].rt_rtx), NULL, cookie);
        ...
        case MEM:
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[1].rt_mem), NULL, cookie);
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[0].rt_rtx), NULL, cookie);
          break;
        case CONCATN:
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[0].rt_rtvec), NULL, cookie);
          break;
        case CONCAT:
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[1].rt_rtx), NULL, cookie);
        ...
        case ADDR_DIFF_VEC:
          ...
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[2].rt_rtx), NULL, cookie);
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[1].rt_rtvec), NULL, cookie);
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[0].rt_rtx), NULL, cookie);
          break;
        case ADDR_VEC:
        ...
        case ASM_OPERANDS:
          ...
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[1].rt_str), NULL, cookie);
          if ((void *)(x) == this_obj)
            op (&((*x).u.fld[0].rt_str), NULL, cookie);
          break;
        case ASM_INPUT:
    ...
    case GSS_ASSUME:
      {
        gimple_statement_assume *sub = static_cast <gimple_statement_assume *> (x);
        if ((void *)(x) == this_obj)
          op (&((*sub).guard), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).body), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).bb), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).next), NULL, cookie);
      }
      break;
    case GSS_WCE:
      {
    ...
    case GSS_OMP_SECTIONS:
      {
        gomp_sections *sub = static_cast <gomp_sections *> (x);
        if ((void *)(x) == this_obj)
          op (&((*sub).clauses), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).control), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).body), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).bb), NULL, cookie);
    ...
    case GSS_OMP_PARALLEL_LAYOUT:
      {
        ...
        if ((void *)(x) == this_obj)
          op (&((*sub).clauses), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).child_fn), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).data_arg), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).body), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).bb), NULL, cookie);
    ...
    case GSS_OMP_TASK:
      {
        gomp_task *sub = static_cast <gomp_task *> (x);
        if ((void *)(x) == this_obj)
          op (&((*sub).copy_fn), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).arg_size), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).arg_align), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).clauses), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).child_fn), NULL, cookie);
          ...
          if ((*sub).iter != NULL) {
            ...
            for (i0 = 0; i0 != (size_t)(l0) && ((void *)(*sub).iter == this_obj); i0++) {
              if ((void *)((*sub).iter) == this_obj)
                op (&((*sub).iter[i0].index), NULL, cookie);
              if ((void *)((*sub).iter) == this_obj)
                op (&((*sub).iter[i0].initial), NULL, cookie);
              if ((void *)((*sub).iter) == this_obj)
                op (&((*sub).iter[i0].final), NULL, cookie);
              if ((void *)((*sub).iter) == this_obj)
                op (&((*sub).iter[i0].incr), NULL, cookie);
            }
            if ((void *)(x) == this_obj)
              op (&((*sub).iter), NULL, cookie);
          }
          if ((void *)(x) == this_obj)
            op (&((*sub).pre_body), NULL, cookie);
          if ((void *)(x) == this_obj)
            op (&((*sub).body), NULL, cookie);
          if ((void *)(x) == this_obj)
            op (&((*sub).bb), NULL, cookie);
    ...
    case GSS_OMP_CONTINUE:
      {
        gomp_continue *sub = static_cast <gomp_continue *> (x);
        if ((void *)(x) == this_obj)
          op (&((*sub).control_def), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).control_use), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).bb), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).next), NULL, cookie);
    ...
    case GSS_OMP_ATOMIC_LOAD:
      {
        gomp_atomic_load *sub = static_cast <gomp_atomic_load *> (x);
        if ((void *)(x) == this_obj)
          op (&((*sub).rhs), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).lhs), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).bb), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).next), NULL, cookie);
    ...
    case GSS_PHI:
      {
        gphi *sub = static_cast <gphi *> (x);
        {
          size_t l1 = (size_t)(((*sub)).nargs);
          if ((void *)(x) == this_obj)
            op (&((*sub).result), NULL, cookie);
          {
            size_t i1;
            for (i1 = 0; i1 != l1; i1++) {
              if ((void *)(x) == this_obj)
                op (&((*sub).args[i1].def), NULL, cookie);
            }
          }
          if ((void *)(x) == this_obj)
            op (&((*sub).bb), NULL, cookie);
    ...
    case GSS_EH_ELSE:
      {
        geh_else *sub = static_cast <geh_else *> (x);
        if ((void *)(x) == this_obj)
          op (&((*sub).n_body), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).e_body), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).bb), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).next), NULL, cookie);
    ...
    case GSS_EH_FILTER:
      {
        geh_filter *sub = static_cast <geh_filter *> (x);
        if ((void *)(x) == this_obj)
          op (&((*sub).types), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).failure), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).bb), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).next), NULL, cookie);
    ...
    case GSS_BIND:
      {
        gbind *sub = static_cast <gbind *> (x);
        if ((void *)(x) == this_obj)
          op (&((*sub).vars), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).block), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).body), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).bb), NULL, cookie);
    ...
    case GSS_TRANSACTION:
      {
        ...
        if ((void *)(x) == this_obj)
          op (&((*sub).body), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).label_norm), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).label_uninst), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).label_over), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).bb), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).next), NULL, cookie);
    ...
    case GSS_CALL:
      {
        gcall *sub = static_cast <gcall *> (x);
        {
          size_t l2 = (size_t)(((*sub)).num_ops);
          if ((void *)(x) == this_obj)
            op (&((*sub).call_used.vars), NULL, cookie);
          if ((void *)(x) == this_obj)
            op (&((*sub).call_clobbered.vars), NULL, cookie);
          switch ((int) (((*sub)).subcode & GF_CALL_INTERNAL))
            {
            case 0:
              if ((void *)(x) == this_obj)
                op (&((*sub).u.fntype), NULL, cookie);
              break;
            case GF_CALL_INTERNAL:
              break;
            default:
    ...
    case GSS_ASM:
      {
        gasm *sub = static_cast <gasm *> (x);
        {
          size_t l3 = (size_t)(((*sub)).num_ops);
          if ((void *)(x) == this_obj)
            op (&((*sub).string), NULL, cookie);
          {
            size_t i3;
            for (i3 = 0; i3 != l3; i3++) {
              if ((void *)(x) == this_obj)
                op (&((*sub).op[i3]), NULL, cookie);
            }
          }
          if ((void *)(x) == this_obj)
            op (&((*sub).bb), NULL, cookie);
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (((*x)).type))
    ...
    case SYMTAB_SYMBOL:
      ...
      if ((void *)(x) == this_obj)
        op (&((*x).next_sharing_asm_name), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).previous_sharing_asm_name), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).same_comdat_group), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).alias_target), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).lto_file_data), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).x_comdat_group), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).x_section), NULL, cookie);
      break;
    case SYMTAB_VARIABLE:
      {
        varpool_node *sub = static_cast <varpool_node *> (x);
        if ((void *)(x) == this_obj)
          op (&((*sub).decl), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).next), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).previous), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).next_sharing_asm_name), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).previous_sharing_asm_name), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).same_comdat_group), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).alias_target), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).lto_file_data), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).x_comdat_group), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).x_section), NULL, cookie);
      }
      break;
    case SYMTAB_FUNCTION:
      {
        cgraph_node *sub = static_cast <cgraph_node *> (x);
        if ((void *)(x) == this_obj)
          op (&((*sub).callees), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).callers), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).indirect_calls), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).next_sibling_clone), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).prev_sibling_clone), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).clones), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).clone_of), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).call_site_hash), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).former_clone_of), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).simdclone), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).simd_clones), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).inlined_to), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).rtl), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).decl), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).next), NULL, cookie);
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).caller), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).callee), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).prev_caller), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).next_caller), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).prev_callee), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).next_callee), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).call_stmt), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).indirect_info), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (SECTION_STYLE (&(((*x))))))
    ...
    case SECTION_NAMED:
      if ((void *)(x) == this_obj)
        op (&((*x).named.name), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).named.decl), NULL, cookie);
      break;
    case SECTION_UNNAMED:
      if ((void *)(x) == this_obj)
        gt_pch_note_callback (&((*x).unnamed.callback), this_obj);
      if ((void *)(x) == this_obj)
        op (&((*x).unnamed.data), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).unnamed.next), NULL, cookie);
      break;
    case SECTION_NOSWITCH:
      if ((void *)(x) == this_obj)
        gt_pch_note_callback (&((*x).noswitch.callback), this_obj);
      break;
    default:
      break;
    }
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).x_str_align_functions), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_str_align_jumps), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_str_align_labels), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_str_align_loops), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_flag_patchable_function_entry), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).preds), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).succs), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).loop_father), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).prev_bb), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).next_bb), NULL, cookie);
  switch ((int) (((((*x)).flags & BB_RTL) != 0)))
    {
    case 0:
      if ((void *)(x) == this_obj)
        op (&((*x).il.gimple.seq), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).il.gimple.phi_nodes), NULL, cookie);
      break;
    case 1:
      if ((void *)(x) == this_obj)
        op (&((*x).il.x.head_), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).il.x.rtl), NULL, cookie);
      break;
    default:
      break;
    }
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).sect), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).objects), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).anchors), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).eh), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).cfg), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).gimple_body), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).gimple_df), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_current_loops), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).pass_startwith), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).su), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).decl), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).static_chain_decl), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).nonlocal_goto_save_area), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).local_decls), NULL, cookie);
  gcc_assert (!(*x).machine);
  if ((void *)(x) == this_obj)
    op (&((*x).language), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).used_types_hash), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).fde), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct target_rtl * x ATTRIBUTE_UNUSED = (struct target_rtl *)x_p;
  {
    ...
    for (i0 = 0; i0 != l0; i0++) {
      if ((void *)(x) == this_obj)
        op (&((*x).x_global_rtl[i0]), NULL, cookie);
    }
  }
  if ((void *)(x) == this_obj)
    op (&((*x).x_pic_offset_table_rtx), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_return_address_pointer_rtx), NULL, cookie);
  {
    size_t i1;
    size_t l1 = (size_t)(FIRST_PSEUDO_REGISTER);
    for (i1 = 0; i1 != l1; i1++) {
      if ((void *)(x) == this_obj)
        op (&((*x).x_initial_regno_reg_rtx[i1]), NULL, cookie);
    }
  }
  {
    size_t i2;
    ...
    for (i2 = 0; i2 != l2; i2++) {
      if ((void *)(x) == this_obj)
        op (&((*x).x_top_of_stack[i2]), NULL, cookie);
    }
  }
  {
    size_t i3;
    ...
    for (i3 = 0; i3 != l3; i3++) {
      if ((void *)(x) == this_obj)
        op (&((*x).x_static_reg_base_value[i3]), NULL, cookie);
    }
  }
  {
    size_t i4;
    ...
    for (i4 = 0; i4 != l4; i4++) {
      if ((void *)(x) == this_obj)
        op (&((*x).x_mode_mem_attrs[i4]), NULL, cookie);
    }
  }
}
...
void
gt_pch_p_14vrange_storage (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vrange_storage * x ATTRIBUTE_UNUSED = (struct vrange_storage *)x_p;
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).rtl), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).libfuncs), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct target_libfuncs * x ATTRIBUTE_UNUSED = (struct target_libfuncs *)x_p;
  {
    ...
    for (i0 = 0; i0 != l0; i0++) {
      if ((void *)(x) == this_obj)
        op (&((*x).x_libfunc_table[i0]), NULL, cookie);
    }
  }
  if ((void *)(x) == this_obj)
    op (&((*x).x_libfunc_hash), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).ssa_names), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).vop), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).escaped.vars), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).escaped_return.vars), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).free_ssanames), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).free_ssanames_queue), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).default_defs), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).ssa_operands.operand_memory), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).tm_restart), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).decl), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dw_fde_begin), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dw_fde_current_label), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dw_fde_end), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dw_fde_vms_end_prologue), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dw_fde_vms_begin_epilogue), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dw_fde_second_begin), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dw_fde_second_end), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dw_fde_cfi), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).callees), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dallocs), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).region_tree), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).region_array), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).lp_array), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).throw_stmt_table), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).ttype_data), NULL, cookie);
  switch ((int) (targetm.arm_eabi_unwinder))
    {
    case 1:
      if ((void *)(x) == this_obj)
        op (&((*x).ehspec_data.arm_eabi), NULL, cookie);
      break;
    case 0:
      if ((void *)(x) == this_obj)
        op (&((*x).ehspec_data.other), NULL, cookie);
      break;
    default:
      break;
    }
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).x_entry_block_ptr), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_exit_block_ptr), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_basic_block_info), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_label_to_block_map), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).larray), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).exits), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).tree_root), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).header), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).latch), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).superloops), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).inner), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).next), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).nb_iterations), NULL, cookie);
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x).nb_iterations_upper_bound), op, cookie);
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x).nb_iterations_likely_upper_bound), op, cookie);
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x).nb_iterations_estimate), op, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).simduid), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).bounds), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).control_ivs), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).exits), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).simple_loop_desc), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).former_header), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).out_edge), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).in_edge), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).assumptions), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).noloop_assumptions), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).infinite), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).niter_expr), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).end_), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).header_), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).footer_), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).current_decl_state), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).global_decl_state), NULL, cookie);
  if ((void *)(x) == this_obj)
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct cgraph_simd_clone * x ATTRIBUTE_UNUSED = (struct cgraph_simd_clone *)x_p;
  {
    size_t l0 = (size_t)(((*x)).nargs);
    if ((void *)(x) == this_obj)
      op (&((*x).prev_clone), NULL, cookie);
    if ((void *)(x) == this_obj)
      op (&((*x).next_clone), NULL, cookie);
    if ((void *)(x) == this_obj)
      op (&((*x).origin), NULL, cookie);
    {
      size_t i0;
      for (i0 = 0; i0 != l0; i0++) {
        if ((void *)(x) == this_obj)
          op (&((*x).args[i0].orig_arg), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*x).args[i0].orig_type), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*x).args[i0].vector_arg), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*x).args[i0].vector_type), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*x).args[i0].simd_array), NULL, cookie);
      }
    }
  }
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).this_node), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).prev), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).next), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dispatcher_resolver), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).context.outer_type), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).context.speculative_outer_type), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).otr_type), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).tree_map), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).param_adjustments), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).nodes), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).asmnodes), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).asm_last_node), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).section_hash), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).assembler_name_hash), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).init_priority_hash), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).m_thunks), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).m_clones), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct lto_in_decl_state * x ATTRIBUTE_UNUSED = (struct lto_in_decl_state *)x_p;
  {
    ...
    for (i0 = 0; i0 != l0; i0++) {
      if ((void *)(x) == this_obj)
        op (&((*x).streams[i0]), NULL, cookie);
    }
  }
  if ((void *)(x) == this_obj)
    op (&((*x).fn_decl), NULL, cookie);
}
...
void
gt_pch_p_6ipa_vr (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct ipa_vr * x ATTRIBUTE_UNUSED = (struct ipa_vr *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).m_storage), NULL, cookie);
  if ((void *)(x) == this_obj)
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).jump_functions), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).polymorphic_call_contexts), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).conds), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).loop_iterations), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).loop_strides), NULL, cookie);
}
...
{
    op (&((*x).type), NULL, cookie);
    op (&((*x).alias_ptr_type), NULL, cookie);
}
...
void
gt_pch_p_37hash_map_location_hash_nowarn_spec_t_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_map<location_hash,nowarn_spec_t> * x ATTRIBUTE_UNUSED = (struct hash_map<location_hash,nowarn_spec_t> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (dw_cfi_oprnd1_desc (((*x)).dw_cfi_opc)))
    ...
    case dw_cfi_oprnd_addr:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_cfi_oprnd1.dw_cfi_addr), NULL, cookie);
      break;
    case dw_cfi_oprnd_loc:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_cfi_oprnd1.dw_cfi_loc), NULL, cookie);
      break;
    case dw_cfi_oprnd_cfa_loc:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_cfi_oprnd1.dw_cfi_cfa_loc), NULL, cookie);
      break;
    default:
      break;
    }
  switch ((int) (dw_cfi_oprnd2_desc (((*x)).dw_cfi_opc)))
    ...
    case dw_cfi_oprnd_addr:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_cfi_oprnd2.dw_cfi_addr), NULL, cookie);
      break;
    case dw_cfi_oprnd_loc:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_cfi_oprnd2.dw_cfi_loc), NULL, cookie);
      break;
    case dw_cfi_oprnd_cfa_loc:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_cfi_oprnd2.dw_cfi_cfa_loc), NULL, cookie);
      break;
    default:
      break;
    }
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).dw_loc_next), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dw_loc_oprnd1.val_entry), NULL, cookie);
  switch ((int) (((*x).dw_loc_oprnd1).val_class))
    {
    case dw_val_class_addr:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_addr), NULL, cookie);
      break;
    case dw_val_class_offset:
      break;
    case dw_val_class_loc_list:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_loc_list), NULL, cookie);
      break;
    case dw_val_class_view_list:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_view_list), NULL, cookie);
      break;
    case dw_val_class_loc:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_loc), NULL, cookie);
      break;
    default:
      break;
    case dw_val_class_unsigned_const:
    ...
    case dw_val_class_wide_int:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_wide), NULL, cookie);
      break;
    case dw_val_class_vec:
      if ((*x).dw_loc_oprnd1.v.val_vec.array != NULL) {
        if ((void *)(x) == this_obj)
          op (&((*x).dw_loc_oprnd1.v.val_vec.array), NULL, cookie);
      }
      break;
    case dw_val_class_die_ref:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_die_ref.die), NULL, cookie);
      break;
    case dw_val_class_fde_ref:
      break;
    case dw_val_class_str:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_str), NULL, cookie);
      break;
    case dw_val_class_lbl_id:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_lbl_id), NULL, cookie);
      break;
    case dw_val_class_flag:
      break;
    case dw_val_class_file:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_file), NULL, cookie);
      break;
    case dw_val_class_file_implicit:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_file_implicit), NULL, cookie);
      break;
    case dw_val_class_data8:
      break;
    case dw_val_class_decl_ref:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_decl_ref), NULL, cookie);
      break;
    case dw_val_class_vms_delta:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_vms_delta.lbl1), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_vms_delta.lbl2), NULL, cookie);
      break;
    case dw_val_class_discr_value:
      switch ((int) (((*x).dw_loc_oprnd1.v.val_discr_value).pos))
        {
    ...
    case dw_val_class_discr_list:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_discr_list), NULL, cookie);
      break;
    case dw_val_class_symview:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd1.v.val_symbolic_view), NULL, cookie);
      break;
    }
  if ((void *)(x) == this_obj)
    op (&((*x).dw_loc_oprnd2.val_entry), NULL, cookie);
  switch ((int) (((*x).dw_loc_oprnd2).val_class))
    {
    case dw_val_class_addr:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_addr), NULL, cookie);
      break;
    case dw_val_class_offset:
      break;
    case dw_val_class_loc_list:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_loc_list), NULL, cookie);
      break;
    case dw_val_class_view_list:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_view_list), NULL, cookie);
      break;
    case dw_val_class_loc:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_loc), NULL, cookie);
      break;
    default:
      break;
    case dw_val_class_unsigned_const:
    ...
    case dw_val_class_wide_int:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_wide), NULL, cookie);
      break;
    case dw_val_class_vec:
      if ((*x).dw_loc_oprnd2.v.val_vec.array != NULL) {
        if ((void *)(x) == this_obj)
          op (&((*x).dw_loc_oprnd2.v.val_vec.array), NULL, cookie);
      }
      break;
    case dw_val_class_die_ref:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_die_ref.die), NULL, cookie);
      break;
    case dw_val_class_fde_ref:
      break;
    case dw_val_class_str:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_str), NULL, cookie);
      break;
    case dw_val_class_lbl_id:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_lbl_id), NULL, cookie);
      break;
    case dw_val_class_flag:
      break;
    case dw_val_class_file:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_file), NULL, cookie);
      break;
    case dw_val_class_file_implicit:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_file_implicit), NULL, cookie);
      break;
    case dw_val_class_data8:
      break;
    case dw_val_class_decl_ref:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_decl_ref), NULL, cookie);
      break;
    case dw_val_class_vms_delta:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_vms_delta.lbl1), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_vms_delta.lbl2), NULL, cookie);
      break;
    case dw_val_class_discr_value:
      switch ((int) (((*x).dw_loc_oprnd2.v.val_discr_value).pos))
        {
    ...
    case dw_val_class_discr_list:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_discr_list), NULL, cookie);
      break;
    case dw_val_class_symview:
      if ((void *)(x) == this_obj)
        op (&((*x).dw_loc_oprnd2.v.val_symbolic_view), NULL, cookie);
      break;
    }
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).dw_discr_next), NULL, cookie);
  switch ((int) (((*x).dw_discr_lower_bound).pos))
    {
    case 0:
      break;
...
void
gt_pch_p_11dw_wide_int (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct dw_wide_int * x ATTRIBUTE_UNUSED = (struct dw_wide_int *)x_p;
}
...
void
gt_pch_p_10ctf_string (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct ctf_string * x ATTRIBUTE_UNUSED = (struct ctf_string *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).cts_str), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).cts_next), NULL, cookie);
}

void
gt_pch_p_9ctf_dmdef (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct ctf_dmdef * x ATTRIBUTE_UNUSED = (struct ctf_dmdef *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).dmd_name), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dmd_next), NULL, cookie);
}

void
gt_pch_p_12ctf_func_arg (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct ctf_func_arg * x ATTRIBUTE_UNUSED = (struct ctf_func_arg *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).farg_name), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).farg_next), NULL, cookie);
}

void
gt_pch_p_9ctf_dtdef (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct ctf_dtdef * x ATTRIBUTE_UNUSED = (struct ctf_dtdef *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).dtd_key), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dtd_name), NULL, cookie);
  switch ((int) (0))
    {
    case 0:
      break;
  ...
  switch ((int) (ctf_dtu_d_union_selector (&((*x)))))
    ...
    case CTF_DTU_D_MEMBERS:
      if ((void *)(x) == this_obj)
        op (&((*x).dtd_u.dtu_members), NULL, cookie);
      break;
    case CTF_DTU_D_ARRAY:
      break;
    case CTF_DTU_D_ENCODING:
    ...
    case CTF_DTU_D_ARGUMENTS:
      if ((void *)(x) == this_obj)
        op (&((*x).dtd_u.dtu_argv), NULL, cookie);
      break;
    case CTF_DTU_D_SLICE:
      break;
    default:
...
void
gt_pch_nx (struct ctf_dtdef* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).dtd_key), NULL, cookie);
...
void
gt_pch_p_9ctf_dvdef (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct ctf_dvdef * x ATTRIBUTE_UNUSED = (struct ctf_dvdef *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).dvd_key), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).dvd_name), NULL, cookie);
}

void
gt_pch_nx (struct ctf_dvdef* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).dvd_key), NULL, cookie);
...
void
gt_pch_p_27hash_table_ctfc_dtd_hasher_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_table<ctfc_dtd_hasher> * x ATTRIBUTE_UNUSED = (struct hash_table<ctfc_dtd_hasher> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct ctfc_dtd_hasher* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
...
void
gt_pch_p_27hash_table_ctfc_dvd_hasher_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_table<ctfc_dvd_hasher> * x ATTRIBUTE_UNUSED = (struct hash_table<ctfc_dvd_hasher> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct ctfc_dvd_hasher* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct ctf_container * x ATTRIBUTE_UNUSED = (struct ctf_container *)x_p;
  {
    ...
    size_t l3 = (size_t)(0);
    if ((void *)(x) == this_obj)
      op (&((*x).ctfc_types), NULL, cookie);
    if ((void *)(x) == this_obj)
      op (&((*x).ctfc_vars), NULL, cookie);
    if ((void *)(x) == this_obj)
      op (&((*x).ctfc_ignore_vars), NULL, cookie);
    if ((void *)(x) == this_obj)
      op (&((*x).ctfc_strtable.ctstab_head), NULL, cookie);
    if ((void *)(x) == this_obj)
      op (&((*x).ctfc_strtable.ctstab_tail), NULL, cookie);
    if ((void *)(x) == this_obj)
      op (&((*x).ctfc_strtable.ctstab_estr), NULL, cookie);
    if ((void *)(x) == this_obj)
      op (&((*x).ctfc_aux_strtable.ctstab_head), NULL, cookie);
    if ((void *)(x) == this_obj)
      op (&((*x).ctfc_aux_strtable.ctstab_tail), NULL, cookie);
    if ((void *)(x) == this_obj)
      op (&((*x).ctfc_aux_strtable.ctstab_estr), NULL, cookie);
    if ((*x).ctfc_vars_list != NULL) {
      size_t i0;
      for (i0 = 0; i0 != (size_t)(l0) && ((void *)(*x).ctfc_vars_list == this_obj); i0++) {
        if ((void *)((*x).ctfc_vars_list) == this_obj)
          op (&((*x).ctfc_vars_list[i0]), NULL, cookie);
      }
      if ((void *)(x) == this_obj)
        op (&((*x).ctfc_vars_list), NULL, cookie);
    }
    if ((*x).ctfc_types_list != NULL) {
      size_t i1;
      for (i1 = 0; i1 != (size_t)(l1) && ((void *)(*x).ctfc_types_list == this_obj); i1++) {
        if ((void *)((*x).ctfc_types_list) == this_obj)
          op (&((*x).ctfc_types_list[i1]), NULL, cookie);
      }
      if ((void *)(x) == this_obj)
        op (&((*x).ctfc_types_list), NULL, cookie);
    }
    if ((*x).ctfc_gfuncs_list != NULL) {
      size_t i2;
      for (i2 = 0; i2 != (size_t)(l2) && ((void *)(*x).ctfc_gfuncs_list == this_obj); i2++) {
        if ((void *)((*x).ctfc_gfuncs_list) == this_obj)
          op (&((*x).ctfc_gfuncs_list[i2]), NULL, cookie);
      }
      if ((void *)(x) == this_obj)
        op (&((*x).ctfc_gfuncs_list), NULL, cookie);
    }
    if ((*x).ctfc_gobjts_list != NULL) {
      size_t i3;
      for (i3 = 0; i3 != (size_t)(l3) && ((void *)(*x).ctfc_gobjts_list == this_obj); i3++) {
        if ((void *)((*x).ctfc_gobjts_list) == this_obj)
          op (&((*x).ctfc_gobjts_list[i3]), NULL, cookie);
      }
      if ((void *)(x) == this_obj)
        op (&((*x).ctfc_gobjts_list), NULL, cookie);
    }
  }
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).inner), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).next_peer), NULL, cookie);
  switch ((int) ((*x).type))
    {
    case ERT_TRY:
      if ((void *)(x) == this_obj)
        op (&((*x).u.eh_try.first_catch), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).u.eh_try.last_catch), NULL, cookie);
      break;
    case ERT_ALLOWED_EXCEPTIONS:
      if ((void *)(x) == this_obj)
        op (&((*x).u.allowed.type_list), NULL, cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).u.allowed.label), NULL, cookie);
      break;
    case ERT_MUST_NOT_THROW:
      if ((void *)(x) == this_obj)
        op (&((*x).u.must_not_throw.failure_decl), NULL, cookie);
      break;
    default:
      break;
    }
  if ((void *)(x) == this_obj)
    op (&((*x).landing_pads), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).exc_ptr_reg), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).filter_reg), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).next_lp), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).region), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).post_landing_pad), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).landing_pad), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).next_catch), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).prev_catch), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).type_list), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).filter_list), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).label), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).stmt), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).label_or_list), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (((*x)).jftype))
    {
    case IPA_JF_CONST:
        op (&((*x).value.constant), NULL, cookie);
      break;
    case IPA_JF_PASS_THROUGH:
        op (&((*x).value.pass_through.operand), NULL, cookie);
      break;
    case IPA_JF_LOAD_AGG:
        op (&((*x).value.load_agg.pass_through.operand), NULL, cookie);
        op (&((*x).value.load_agg.type), NULL, cookie);
      break;
    default:
      break;
    }
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).m_agg_values), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).m_vr), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).m_uid_to_idx), NULL, cookie);
}
...
gt_pch_nx (struct ipa_param_descriptor* x ATTRIBUTE_UNUSED,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).decl_or_type), NULL, cookie);
}

void
gt_pch_p_27vec_ipa_argagg_value_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<ipa_argagg_value,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<ipa_argagg_value,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct ipa_argagg_value* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).value), NULL, cookie);
...
void
gt_pch_p_33vec_ipa_uid_to_idx_map_elt_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<ipa_uid_to_idx_map_elt,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<ipa_uid_to_idx_map_elt,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct ipa_uid_to_idx_map_elt* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
...
gt_pch_nx (struct ipa_jump_func* x ATTRIBUTE_UNUSED,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).agg.items), NULL, cookie);
    op (&((*x).m_vr), NULL, cookie);
  switch ((int) (((*x)).type))
    {
    case IPA_JF_CONST:
        op (&((*x).value.constant.value), NULL, cookie);
      break;
    case IPA_JF_PASS_THROUGH:
        op (&((*x).value.pass_through.operand), NULL, cookie);
      break;
...
gt_pch_nx (struct ipa_polymorphic_call_context* x ATTRIBUTE_UNUSED,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).outer_type), NULL, cookie);
    op (&((*x).speculative_outer_type), NULL, cookie);
}
...
{
    op (&((*x).type), NULL, cookie);
    op (&((*x).val), NULL, cookie);
    op (&((*x).param_ops), NULL, cookie);
}
  ...
  if (regno_reg_rtx != NULL) {
    ...
    for (i0 = 0; i0 != (size_t)(crtl->emit.x_reg_rtx_no) && ((void *)regno_reg_rtx == this_obj); i0++) {
      if ((void *)(regno_reg_rtx) == this_obj)
        op (&(regno_reg_rtx[i0]), NULL, cookie);
    }
    if ((void *)(&regno_reg_rtx) == this_obj)
      op (&(regno_reg_rtx), NULL, cookie);
  }
}
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gtype_desc_cc[] = {
  {
  ...
  {
    &x_rtl.x_function_beg_insn,
    1,
    sizeof (x_rtl.x_function_beg_insn),
    &gt_ggc_mx_rtx_def,
    &gt_pch_nx_rtx_def
  },
  {
  ...
  },
  {
    ...
    1,
    sizeof (tu_ctfc),
    &gt_ggc_mx_ctf_container,
    &gt_pch_nx_ctf_container
  },
  {
    &cie_cfi_vec,
    1,
  ...
  },
  {
    ...
    1,
    sizeof (nowarn_map),
    &gt_ggc_mx_hash_map_location_hash_nowarn_spec_t_,
    &gt_pch_nx_hash_map_location_hash_nowarn_spec_t_
  },
  {
    &saved_symtab,
    1,
...
EXPORTED_CONST struct ggc_root_tab gt_pch_rs_gtype_desc_cc[] = {
