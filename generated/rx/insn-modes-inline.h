...
mode_size_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CC_ZSmode: return 4;
    case E_CC_ZSOmode: return 4;
    case E_CC_ZSCmode: return 4;
    case E_CC_Fmode: return 4;
...
mode_nunits_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CC_ZSmode: return 1;
    case E_CC_ZSOmode: return 1;
    case E_CC_ZSCmode: return 1;
    case E_CC_Fmode: return 1;
    case E_BImode: return 1;
    case E_QImode: return 1;
...
mode_inner_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CC_ZSmode: return E_CC_ZSmode;
    case E_CC_ZSOmode: return E_CC_ZSOmode;
    case E_CC_ZSCmode: return E_CC_ZSCmode;
    case E_CC_Fmode: return E_CC_Fmode;
...
mode_unit_precision_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CC_ZSmode: return 4*BITS_PER_UNIT;
    case E_CC_ZSOmode: return 4*BITS_PER_UNIT;
    case E_CC_ZSCmode: return 4*BITS_PER_UNIT;
    case E_CC_Fmode: return 4*BITS_PER_UNIT;
    case E_BImode: return 1;
