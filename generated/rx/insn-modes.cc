/* Generated automatically from machmode.def and config/rx/rx-modes.def
   by genmodes.  */
...
const poly_uint16 mode_precision[NUM_MACHINE_MODES] = 
{
  { 0 },                   /* VOID */
  { 0 },                   /* BLK */
  { 4 * BITS_PER_UNIT },   /* CC */
  { 4 * BITS_PER_UNIT },   /* CC_ZS */
  { 4 * BITS_PER_UNIT },   /* CC_ZSO */
  { 4 * BITS_PER_UNIT },   /* CC_ZSC */
  { 4 * BITS_PER_UNIT },   /* CC_F */
  { 1 },                   /* BI */
  { 1 * BITS_PER_UNIT },   /* QI */
  { 2 * BITS_PER_UNIT },   /* HI */
  { 4 * BITS_PER_UNIT },   /* SI */
...
const poly_uint16 mode_size[NUM_MACHINE_MODES] = 
{
  { 0 },                   /* VOID */
  { 0 },                   /* BLK */
  { 4 },                   /* CC */
...
const poly_uint16 mode_nunits[NUM_MACHINE_MODES] = 
{
  { 0 },                   /* VOID */
  { 0 },                   /* BLK */
  { 1 },                   /* CC */
...
#define MODE_MASK(m)                          \
  ...
  MODE_MASK (4*BITS_PER_UNIT),   /* CC_ZS */
  MODE_MASK (4*BITS_PER_UNIT),   /* CC_ZSO */
  MODE_MASK (4*BITS_PER_UNIT),   /* CC_ZSC */
  MODE_MASK (4*BITS_PER_UNIT),   /* CC_F */
  MODE_MASK (1),           /* BI */
...
init_adjust_machine_modes (void)
{
  ...
  gcc_assert (maybe_ne (mode_size[E_CC_ZSmode], -1));

  gcc_assert (maybe_ne (mode_size[E_CC_ZSOmode], -1));

  gcc_assert (maybe_ne (mode_size[E_CC_ZSCmode], -1));

  gcc_assert (maybe_ne (mode_size[E_CC_Fmode], -1));
