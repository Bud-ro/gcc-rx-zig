...
/* 32 bit ELF emulation code for elf32rx
...
static void gldelf32rx_before_parse (void);
static void gldelf32rx_before_plugin_all_symbols_read
  (void);
static void gldelf32rx_after_open (void);
static void gldelf32rx_before_allocation (void);
static void gldelf32rx_after_allocation (void);
...
static void
gldelf32rx_before_parse (void)
{
  ldfile_set_output_arch ("rx", bfd_arch_rx);
...
static void
gldelf32rx_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32rx_after_open (void)
{
  ldelf_after_open (true, false,
		    false, false, 32, "/usr/local/rx-elf");
}
...
static void
gldelf32rx_before_allocation (void)
{
...
static void
gldelf32rx_after_allocation (void)
{
...
static char *
gldelf32rx_get_script (int *isfile)
{
  *isfile = 0;
...
OUTPUT_FORMAT(\"elf32-rx-le\", \"elf32-rx-le\",\n\
	      \"elf32-rx-le\")\n\
OUTPUT_ARCH(rx)\n\
...
OUTPUT_ARCH(rx)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/usr/local/rx-elf/rx-elf/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
...
"  /* Adjust the address for the rodata segment.  We want to adjust up to\n\
     the same address within the page on the next page up.  */\n\
  . = SEGMENT_START(\"rodata-segment\", ALIGN(256) + (. & (256 - 1)));\n\
  .rodata         : { *(.rodata .rodata.* .gnu.linkonce.r.*) }\n\
  .rodata1        : { *(.rodata1) }\n\
  .sdata2         :\n\
  {\n\
...
static bool
gldelf32rx_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32rx_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32rx_emulation =
{
  gldelf32rx_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32rx_before_plugin_all_symbols_read,
  gldelf32rx_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32rx_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32rx_before_allocation,
  gldelf32rx_get_script,
  "elf32rx",
  "elf32-rx-le",
  finish_default,
  ...
  NULL,
  gldelf32rx_add_options,
  gldelf32rx_handle_option,
  NULL,
  gldelf32rx_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  rx_additional_link_map_text,
