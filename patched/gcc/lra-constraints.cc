...
{
  // FIXME: This is disabled on RX for now b/c of a crash / failed to recog instruction.
  // ASHIFT has clobber CC but can't be added locally / here, but in lra_emit_add() at /
  // after emit_move_insn (x, y); where y is the address changed here.
#if 0
