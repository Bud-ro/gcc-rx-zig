...
#define int16_ptr_type_node		global_trees[TI_INT16_PTR_TYPE]
#define integer_ptr_type_node		global_trees[TI_INTEGER_PTR_TYPE]
#define char_ptr_type_node		global_trees[TI_CHAR_PTR_TYPE]
#define volatile_char_ptr_type_node    global_trees[TI_VOLATILE_CHAR_PTR_TYPE]
