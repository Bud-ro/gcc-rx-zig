...
static const struct default_options default_options_table[] =
  ...
  /* Only run the pre-regalloc scheduling pass if optimizing for speed.  */
    ...
    /* Enable options by default at -Os */
    { OPT_LEVELS_SIZE, OPT_fsection_anchors, NULL, 1 },
    { OPT_LEVELS_SIZE, OPT_fcommon, NULL, 0 },
    { OPT_LEVELS_SIZE, OPT_free, NULL, 1 },
    { OPT_LEVELS_SIZE, OPT_fdata_sections, NULL, 1 },
    { OPT_LEVELS_SIZE, OPT_ffunction_sections, NULL, 1 },
    { OPT_LEVELS_SIZE, OPT_fpartial_inlining, NULL, 0 },
