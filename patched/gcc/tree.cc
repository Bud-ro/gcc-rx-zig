...
build_common_tree_nodes (bool signed_char)
{
  ...
  int16_ptr_type_node = build_pointer_type(intHI_type_node);
  char_ptr_type_node = build_pointer_type (char_type_node);
  volatile_char_ptr_type_node = build_pointer_type
